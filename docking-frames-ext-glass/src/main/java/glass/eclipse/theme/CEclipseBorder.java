...
public class CEclipseBorder implements Border {
    ...
    public void update4Placement(TabPlacement tabPlacement) {
        switch (tabPlacement) {
            case TOP_OF_DOCKABLE -> roundEdges = (CEclipseBorder.TOP_LEFT | CEclipseBorder.TOP_RIGHT);
            case BOTTOM_OF_DOCKABLE -> roundEdges = (CEclipseBorder.BOTTOM_LEFT | CEclipseBorder.BOTTOM_RIGHT);
            case LEFT_OF_DOCKABLE -> roundEdges = (CEclipseBorder.BOTTOM_LEFT | CEclipseBorder.TOP_LEFT);
            case RIGHT_OF_DOCKABLE -> roundEdges = (CEclipseBorder.BOTTOM_RIGHT | CEclipseBorder.TOP_RIGHT);
        }
    }
