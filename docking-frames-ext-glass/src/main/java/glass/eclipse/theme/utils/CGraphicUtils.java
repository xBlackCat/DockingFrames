...
public class CGraphicUtils {
     ...
     * @return
     */
    public static BufferedImage addPhotoBorder(BufferedImage src, int outer, int inner, Color colOuter,
                                               Color colInner) {
        ...
        g2d.drawImage(src,
                outer + inner,
                outer + inner, img.getWidth() - 2 * (outer + inner), img.getHeight() - 2 * (outer + inner), null);
