...
public class COutlineHelper {
    public static final AffineTransform tRot90CW;
    public static final AffineTransform tRot90CCW;
    public static final AffineTransform atRot90SclX;
    public static final AffineTransform tSclY;
    public static final AffineTransform tSclX;
     ...
     * @return
     */
    public static Shape CreateUnselectedTabShape(int cornerRadius, int w, int h, boolean firstTab, boolean forClip,
