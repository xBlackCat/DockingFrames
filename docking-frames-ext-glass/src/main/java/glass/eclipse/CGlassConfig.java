...
public class CGlassConfig extends JPanel {
    ...
    public enum NGlass {
        UNSELECTED(new SGlassParameter(0.0D, 0.0D, 0.08D, 0.3D, 1.0D, 0.0D, null, null, null, 1.0D, 0.85D, 0.75D,
                0.25D)),
        SELECTED(new SGlassParameter(0.0D, 0.0D, 0.2D, 0.63D, 0.0D, 0.0D, null, null, null, 0.27D, 0.85D, 0.85D,
                0.29D)),
        FOCUSED(new SGlassParameter(0.0D, 0.0D, 0.08D, 0.3D, 1.0D, 0.0D, null, null, null, 1.0D, 0.85D, 0.85D, 1.0D)),
        STRIP(new SGlassParameter(0.25, 0.0, 0.5, 0.0, 0.0, 0.21, new Color(0, 0, 0), new Color(0, 0, 0), new Color(0
                , 0, 0), 0.0, 1.0, 0.7, 0.2)),
    ...
    public static final IGlassParameterFactory FACTORY = new IGlassParameterFactory() {
    ...
    protected void repaintArea() {
        SwingUtilities.invokeLater(() -> CGlassConfig.this.cControl.getContentArea().paintImmediately(CGlassConfig.this.cControl.getContentArea().getBounds()));
    ...
    public CGlassConfig(CControl cControl) {
        ...
        final JComboBox<NGlass> comboBox = new JComboBox<>();
        ...
        color_intensity.addChangeListener(e -> {
        ...
        l_position.addChangeListener(e -> {
        ...
        l_intensity.addChangeListener(e -> {
