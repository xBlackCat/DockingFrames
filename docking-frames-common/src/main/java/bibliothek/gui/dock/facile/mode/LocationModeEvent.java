...
public class LocationModeEvent {
     ...
     */
    private final AffectedSet affected;
    /**
     * the objects that are stored for some listeners
     */
    private final Map<LocationModeListener, Object> map = new HashMap<>();
    ...
    /**
     * Assuming {@link #isDone()} is <code>true</code>, then this flag tells whether the operation was a success or
     * not.
