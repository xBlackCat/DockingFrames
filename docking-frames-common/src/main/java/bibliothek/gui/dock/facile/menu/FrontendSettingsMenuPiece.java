...
public class FrontendSettingsMenuPiece extends NodeMenuPiece {
     ...
     */
    private final FrontendSettingsDeleteList delete;
    /**
     * menu to load items
     */
    private final FrontendSettingsLoadList load;
    ...
    private final MenuPieceText textSave;
    private final MenuPieceText textSaveAs;
    private MenuPieceText textLoad;
    private final MenuPieceText textDelete;
    ...
    public FrontendSettingsMenuPiece(DockFrontend frontend, boolean loadAsSubmenu) {
        ...
        save.addActionListener(e -> save((Component) e.getSource()));

        saveAs.addActionListener(e -> saveAs((Component) e.getSource()));
    }
