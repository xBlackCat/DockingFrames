...
public interface ExtendedModeEnablement {
     ...
     * @return whether the mode is available, most strategies should return  {@link Availability#WEAK_AVAILABLE} if
     * <code>mode</code> equals {@link ExtendedMode#NORMALIZED}.
     * Must never be <code>null</code>, but a result of {@link Availability#UNCERTAIN} indicates that this enablement
     * does not know
     */
    Availability isAvailable(Dockable dockable, ExtendedMode mode);
     ...
     */
    Hidden isHidden(Dockable dockable, ExtendedMode mode);
