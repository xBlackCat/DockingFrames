...
public interface ConflictResolver<T> {
     ...
     */
    double resolveHorizontal(ResizeNode<T> node, ResizeRequest left, double deltaLeft, ResizeRequest right,
                             double deltaRight);
     ...
     * @return how much the divider should be moved
     */
    double resolveVertical(ResizeNode<T> node, ResizeRequest top, double deltaTop, ResizeRequest bottom,
                           double deltaBottom);
}
