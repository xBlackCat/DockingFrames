...
public abstract class AbstractExtendedModeEnablement implements ExtendedModeEnablement {
     ...
     */
    private final List<ExtendedModeEnablementListener> listeners = new ArrayList<>();
     ...
     */
    private final ModeManagerListener<Location, LocationMode> modeManagerListener =
            new ModeManagerListener<>() {
                ...
                public void modeAdded(ModeManager<? extends Location, ? extends LocationMode> manager,
                                      LocationMode mode) {
                    // ignore
                }
    ...
    protected void fire(Dockable dockable, ExtendedMode mode, boolean available) {
        ExtendedModeEnablementListener[] array = listeners.toArray(new ExtendedModeEnablementListener[0]);
