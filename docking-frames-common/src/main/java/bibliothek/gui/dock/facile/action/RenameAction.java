...
public abstract class RenameAction extends SimpleButtonAction {
     ...
     */
    private final DockActionText textOk;

    /**
     * text on the cancel button
     */
    private final DockActionText textCancel;
    ...
    public RenameAction(DockController controller) {
        ...
        okButton.addActionListener(e -> rename());

        cancelButton.addActionListener(e -> menu.setVisible(false));

        titleField.addActionListener(e -> rename());
    }
