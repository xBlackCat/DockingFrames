...
public class CMinimizedLocation extends CFlapLocation {
    ...
    public String findRoot() {
        ...
        return switch (side) {
            case NORTH -> CContentArea.getNorthIdentifier(id);
            case SOUTH -> CContentArea.getSouthIdentifier(id);
            case EAST -> CContentArea.getEastIdentifier(id);
            case WEST -> CContentArea.getWestIdentifier(id);
            default -> null;
        };
    }
