 ...
 */
public class CScreenDockStation extends ScreenDockStation implements CommonDockStation<ScreenDockStation,
        CScreenDockStation> {
    private final CommonStationDelegate<CScreenDockStation> delegate;
