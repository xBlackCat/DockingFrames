...
public class CDockableLocationEvent {
    ...
    private final boolean oldShowing;
    private final boolean newShowing;

    private boolean locationChanged;
    private final CLocation oldLocation;
    private final CLocation newLocation;
     ...
     */
    public CDockableLocationEvent(CDockable dockable, boolean oldShowing, boolean newShowing, CLocation oldLocation,
