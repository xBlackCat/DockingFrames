...
public class CDockFrontend extends DockFrontend {
     ...
     */
    private final List<CDockFrontendListener> listeners = new ArrayList<>();
    ...
    protected CDockFrontendListener[] frontendListeners() {
        return listeners.toArray(new CDockFrontendListener[0]);
    }
    ...
    protected Setting createSetting() {
        ...
        ModeSettings<Location, Location> modeSettings =
                manager.createSettings(new LocationSettingConverter(getController()));
    ...
    public void setSetting(final Setting setting, final boolean entry) {
        ...
        try {
            ...
            manager.runLayoutTransaction(() -> CDockFrontend.super.setSetting(setting, entry));
