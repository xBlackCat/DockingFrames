...
public class ReplacementDockFactory implements DockFactory<CommonDockable, PerspectiveElement, MultipleCDockable> {
    ...
    public MultipleCDockable getPerspectiveLayout(PerspectiveElement element,
    ...
    public void layoutPerspective(PerspectiveElement perspective, MultipleCDockable layout, Map<Integer,
