 ...
 */
public class CommonMultipleDockableFactory implements DockFactory<CommonDockable, CommonElementPerspective,
     ...
     */
    private final MultipleCDockableFactory<MultipleCDockable, MultipleCDockableLayout> delegate;
    /**
     * access to private properties of {@link CControl}
     */
    private final CControlAccess controlAccess;
    /**
    ...
    public void layoutPerspective(CommonElementPerspective perspective, CommonMultipleDockableLayout layout,
    ...
    public CommonElementPerspective layoutPerspective(CommonMultipleDockableLayout layout, Map<Integer,
            PerspectiveDockable> children) {
        MultipleCDockablePerspective perspective =
                new MultipleCDockablePerspective(getID(), layout.getId(), layout.getLayout());
