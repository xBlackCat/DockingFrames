 ...
 * of the framework such that externalized {@link CDockable} are not stacked, but put in a
 * {@link ExternalizingCGridArea}.<br>
    ...
    protected class SplitInserter extends DockStationAdapter {
        public void dockableAdded(DockStation station, final Dockable dockable) {
            if (!(dockable instanceof SplitDockStation)) {
                EventQueue.invokeLater(() -> checkAndReplace(dockable));
            }
        }
        ...
        private void resizeDelayed(final ScreenDockStation station, final Dockable parent, final Dockable dockable,
