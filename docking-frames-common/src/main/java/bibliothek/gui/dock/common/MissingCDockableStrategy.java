...
public interface MissingCDockableStrategy {
     ...
     */
    MissingCDockableStrategy PURGE = new MissingCDockableStrategy() {
     ...
     */
    MissingCDockableStrategy SINGLE = new MissingCDockableStrategy() {
        public boolean shouldStoreSingle(String id) {
            return true;
        }
     ...
     */
    MissingCDockableStrategy STORE = new MissingCDockableStrategy() {
        public boolean shouldStoreSingle(String id) {
            return true;
        }
     ...
     * <code>false</code> if the information should be purged.
     */
    boolean shouldStoreMulti(String id);
     ...
     */
    <L extends MultipleCDockableLayout> boolean shouldCreate(String id, MultipleCDockableFactory<?, L> factory,
                                                             String uniqueId, L data);
}
