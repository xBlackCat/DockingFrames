...
public interface CDockable {
     ...
     */
    String ACTION_KEY_MINIMIZE = "cdockable.minimize";
     ...
     */
    String ACTION_KEY_MAXIMIZE = "cdockable.maximize";
     ...
     */
    String ACTION_KEY_NORMALIZE = "cdockable.normalize";
     ...
     */
    String ACTION_KEY_EXTERNALIZE = "cdockable.externalize";
     ...
     */
    String ACTION_KEY_UNEXTERNALIZE = "cdockable.unexternalize";
     ...
     */
    String ACTION_KEY_UNMAXIMIZE_EXTERNALIZED = "cdockable.unmaximize_externalized";
     ...
     * <code>false</code>.
     */
    String ACTION_KEY_CLOSE = "cdockable.close";
     ...
     */
    String ACTION_KEY_MINIMIZE_HOLD = "cdockable.hold";
     ...
     * @deprecated this method gets replaced by {@link #isShowing()}, which offers the exact same information. This
     * method
     ...
     * {@link Dockable} is visible, then it may or may not change its location and {@link ExtendedMode}. Note that
     * <code>dockable</code> and <code>this</code>
     * must not be the same object, and that both {@link CDockable}s must be
     * {@link CControl#addDockable(bibliothek.gui.dock.common.SingleCDockable) registered}
     * at a {@link CControl}.
     *
     ...
     * @throws IllegalStateException    if <code>this</code> is not registered at the same {@link CControl} as
     * <code>dockable</code>
     */
     ...
     * </ul>
     *
     * @param noBackwardsTransformation if <code>true</code>, then this method should not convert any
     * {@link DockableProperty}
     *                                  back to a {@link CLocation}, instead it should return <code>null</code> if
     *                                  such a conversion would be necessary. This
     *                                  way the method does return <code>null</code> in any case where information (e
     *                                  .g. placeholders) could be lost
     ...
     * {@link CControl#getDefaultLocation() default location} of the <code>CControl</code> or the default location
     * for the
     * {@link ExtendedMode#NORMALIZED normalized extended mode}. A value of <code>null</code> is returned if this
     * {@link CDockable} would appear at a random location, is not registered at a {@link CControl} or is already
     * visible.
     */
    ...
    /**
     * Gets an algorithm that tells how this {@link CDockable} attempts to group itself automatically with other
     * {@link Dockable}s.
     * The algorithm is able to rewrite the location of this {@link CDockable} every time when it is moved to a new
     * location, assuming
     ...
     */
    @FrameworkOnly
    void setControlAccess(CControlAccess control);
