...
public class CMaximizeAction extends CExtendedModeAction {
     ...
     */
    private final PropertyValue<KeyStroke> keyStrokeMaximized = new PropertyValue<>(CControl.KEY_GOTO_MAXIMIZED) {
        @Override
        protected void valueChanged(KeyStroke oldValue, KeyStroke newValue) {
            if (newValue == null) {
    ...
    public CMaximizeAction(CControl control) {
        super(control, ExtendedMode.MAXIMIZED, CLocationModeManager.ICON_MANAGER_KEY_MAXIMIZE, "maximize.in",
                "maximize.in.tooltip", CControl.KEY_GOTO_MAXIMIZED);
    }
