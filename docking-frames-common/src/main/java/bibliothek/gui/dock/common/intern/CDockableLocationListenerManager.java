...
public class CDockableLocationListenerManager {
     ...
     */
    private final DockableStateListener dockableListener = event -> check();
    ...
    private void checkNow() {
        ...
        if (locationEvent || (newShowing != oldShowing)) {
            if (listener != null) {
                CDockableLocationEvent event =
                        new CDockableLocationEvent(dockable, oldShowing, newShowing, oldLocation, newLocation);
