...
public class CDisablingStrategy implements DisablingStrategy {
    ...
    private final CDockablePropertyListener propertyListener = new CDockableAdapter() {
        public void enabledChanged(CDockable dockable) {
            ...
            for (DisablingStrategyListener listener : listeners.toArray(new DisablingStrategyListener[0])) {
     ...
     */
    private final List<DisablingStrategyListener> listeners = new ArrayList<>();
