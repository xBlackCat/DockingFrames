...
public class CGridArea extends AbstractDockableCStation<CSplitDockStation> implements SingleCDockable {
    ...
    protected void init(CControl control, String uniqueId) {
        ...
        CommonDockStation<SplitDockStation, CSplitDockStation> station =
                control.getFactory().createSplitDockStation(new Delegate());
    ...
    /**
     * Creates the handle that will represent <code>this</code> as {@link CNormalModeArea} and
