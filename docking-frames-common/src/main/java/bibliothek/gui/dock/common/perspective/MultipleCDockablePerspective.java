...
public class MultipleCDockablePerspective extends AbstractCDockablePerspective {
     ...
     * @param layout    description of the content of this dockable, will be given to the
     * {@link MultipleCDockableFactory}
    ...
    /**
     * Sets the unique identifier of this element. The identifier can be used to replace an  existing
     * {@link MultipleCDockable}
     * with the dockable that is represented by this. If no identifier is set, then a random identifier will be set
     * when the {@link CPerspective} is applied.
     *
