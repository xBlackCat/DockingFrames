...
public class DefaultSingleCDockable extends DefaultCDockable implements SingleCDockable {
     ...
     *                    A separator is inserted for every entry that is <code>null</code> of this array.
     */
    public DefaultSingleCDockable(String id, Icon icon, String title, Component content, Permissions permissions,
                                  CAction... actions) {
     ...
     *                     A separator is inserted for every entry that is <code>null</code> of this array.
     */
    public DefaultSingleCDockable(String id, Icon icon, IconHandling iconHandling, String title, Component content,
                                  Permissions permissions, CAction... actions) {
