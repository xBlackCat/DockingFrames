...
public abstract class AbstractTreeLocation extends AbstractStackholdingLocation {
    ...
    public SplitDockPathProperty findProperty(DockableProperty successor) {
        ...
        switch (side) {
            case NORTH -> property.add(SplitDockPathProperty.Location.TOP, size, nodeId);
            case SOUTH -> property.add(SplitDockPathProperty.Location.BOTTOM, size, nodeId);
            case EAST -> property.add(SplitDockPathProperty.Location.RIGHT, size, nodeId);
            case WEST -> property.add(SplitDockPathProperty.Location.LEFT, size, nodeId);
        }
