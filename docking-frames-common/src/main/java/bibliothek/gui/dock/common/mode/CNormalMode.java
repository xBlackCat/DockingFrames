...
public class CNormalMode extends NormalMode<CNormalModeArea> implements CLocationMode {
     ...
     */
    private final LocationModeActionProvider normalize;
    /**
     * the action for normalizing an externalized element
     */
    private final LocationModeActionProvider unexternalize;
    ...
    public CNormalMode(CControl control) {
        ...
        unexternalize =
                new KeyedLocationModeActionProvider(CDockable.ACTION_KEY_UNEXTERNALIZE,
                        new CUnexternalizeAction(control));
