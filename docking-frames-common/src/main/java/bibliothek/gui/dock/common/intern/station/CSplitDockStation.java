 ...
 */
@FrameworkOnly
public class CSplitDockStation extends SplitDockStation implements CommonDockStation<SplitDockStation,
        CSplitDockStation>, CommonDockable {
    private final CommonStationDelegate<CSplitDockStation> delegate;
