...
public class CKeyStrokePreferenceModel extends DefaultPreferenceModel {
    private final KeyStrokeInitSelectorPreference initSelector;
    private final ModifierMaskNoCombinationPreference maskNoCombination;
    private final ModifierMaskScreenOnlyPreference maskScreenOnly;

    private final KeyStrokeMaximizeChangePreference maximizeChange;
    private final KeyStrokeMaximizePreference maximize;
    private final KeyStrokeNormalizePreference normalize;
    private final KeyStrokeMinimizePreference minimize;
    private final KeyStrokeExternalizePreference externalize;
    private final KeyStrokeCancelOperation cancel;
