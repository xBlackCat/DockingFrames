...
@Todo(priority = Priority.MAJOR, target = Version.VERSION_1_1_2, compatibility = Compatibility.COMPATIBLE,
        description =
                "The 'unmaximize' button appears at the wrong location. And during drag and drop layout information " +
                        "is lost" +
                        " due to the listener that inserts the station after the dockable was inserted. Also " +
...
public class ExternalizingCGridArea extends CGridArea {
    ...
    protected void tryAutoRemove() {
        ...
        if (control != null) {
            ...
            lock.onRelease(this::autoRemove);
        }
    }
