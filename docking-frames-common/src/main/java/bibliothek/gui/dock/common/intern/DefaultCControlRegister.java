...
public class DefaultCControlRegister implements MutableCControlRegister {
     ...
     */
    private final List<CStationContainer> containers = new ArrayList<>();

    /**
     * A factory used to create missing {@link SingleCDockable}s
     */
    private final CommonSingleDockableFactory backupFactory;

    /**
     * the set of known factories
     */
    private final Map<String, CommonMultipleDockableFactory> factories =
            new HashMap<>();

    /**
     * list of all dockables registered
     */
    private final List<CDockable> dockables =
            new ArrayList<>();

    /**
     * list of all {@link SingleCDockable}s
     */
    private final List<SingleCDockable> singleDockables =
            new ArrayList<>();

    /**
     * the set of {@link MultipleCDockable}s
     */
    private final List<MultipleCDockable> multiDockables =
            new ArrayList<>();

    /**
     * the stations known
     */
    private final List<CStation<?>> stations = new ArrayList<>();

    /**
     * a listener added to all {@link CStationContainer}s, adds or removes {@link CStation}s
     * when necessary
     */
    private final CStationContainerListener containerListener = new CStationContainerListener() {
    ...
    public List<MultipleCDockable> listMultipleDockables(MultipleCDockableFactory<?, ?> factory) {
        List<MultipleCDockable> result = new ArrayList<>();
    ...
    public List<CDockable> listDockablesInMode(ExtendedMode mode) {
        List<CDockable> list = new ArrayList<>();
    ...
    public Map<String, MultipleCDockableFactory<?, ?>> getFactories() {
        Map<String, MultipleCDockableFactory<?, ?>> result = new HashMap<>();
