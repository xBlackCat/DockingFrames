...
public class CPanelPopup extends CDecorateableAction<CPanelPopup.PanelPopup> {
     ...
     */
    private final PanelPopupWindowListener listener = new PanelPopupWindowListener() {
    ...
    protected void openDialog(Dockable dockable, final JComponent item, Orientation orientation) {
        ...
        executeOneDockableHasFocus(dockable, () -> {
     ...
     *
     * @param dockable the element for which this panel is shown
     * @param run      some piece of code to run, usually it will open the popup-dialog created by
     * {@link #createDialogWindow(Component)}.
