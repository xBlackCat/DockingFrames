...
public class CListenerCollection {
     ...
     */
    private final List<CDockableStateListener> stateListeners = new ArrayList<>();

    private final CDockableStateListener stateListener = new CDockableStateListener() {
     ...
     */
    private final List<CDockablePropertyListener> propertyListeners = new ArrayList<>();

    private final CDockablePropertyListener propertyListener = new CDockablePropertyListener() {
     ...
     */
    private final List<CFocusListener> focusListeners = new ArrayList<>();

    private final CFocusListener focusListener = new CFocusListener() {
    ...
    private final List<CVetoFocusListener> vetoFocusListeners = new ArrayList<>();

    private final CVetoFocusListener vetoFocusListener = new CVetoFocusListener() {
    ...
    private final List<CKeyboardListener> keyboardListeners = new ArrayList<>();

    private final CKeyboardListener keyboardListener = new CKeyboardListener() {
    ...
    private final List<CDoubleClickListener> doubleClickListeners = new ArrayList<>();

    private final CDoubleClickListener doubleClickListener = (source, event) -> {
    ...
    private final List<CVetoClosingListener> vetoClosingListeners = new ArrayList<>();

    private final CVetoClosingListener vetoClosingListener = new CVetoClosingListener() {
    ...
    private final List<CDockableLocationListener> locationListeners = new ArrayList<>();

    private final CDockableLocationListener locationListener = event -> {
    ...
    public CDockableStateListener[] getCDockableStateListeners() {
        return stateListeners.toArray(new CDockableStateListener[0]);
    }
    ...
    public CDockableLocationListener[] getCDockableLocationListeners() {
        return locationListeners.toArray(new CDockableLocationListener[0]);
    }
    ...
    public CDockablePropertyListener[] getCDockablePropertyListeners() {
        return propertyListeners.toArray(new CDockablePropertyListener[0]);
    }
    ...
    public CFocusListener[] getFocusListeners() {
        return focusListeners.toArray(new CFocusListener[0]);
    }
    ...
    public CVetoFocusListener[] getVetoFocusListeners() {
        return vetoFocusListeners.toArray(new CVetoFocusListener[0]);
    }
    ...
    public CKeyboardListener[] getKeyboardListeners() {
        return keyboardListeners.toArray(new CKeyboardListener[0]);
    }
    ...
    public CDoubleClickListener[] getDoubleClickListeners() {
        return doubleClickListeners.toArray(new CDoubleClickListener[0]);
    }
    ...
    public CVetoClosingListener[] getVetoClosingListeners() {
        return vetoClosingListeners.toArray(new CVetoClosingListener[0]);
    }
}
