...
public class DefaultMultipleCDockable extends DefaultCDockable implements MultipleCDockable {
     ...
     */
    private final MultipleCDockableFactory<?, ?> factory;
     ...
     *                kind of dockable. A value of <code>null</code> will default ot the
     *                {@link NullMultipleCDockableFactory}.
     ...
     *                A separator is inserted for every entry that is <code>null</code> of this array.
     */
    public DefaultMultipleCDockable(MultipleCDockableFactory<?, ?> factory, String title, Component content,
                                    CAction... actions) {
     ...
     *                A separator is inserted for every entry that is <code>null</code> of this array.
     */
    public DefaultMultipleCDockable(MultipleCDockableFactory<?, ?> factory, Icon icon, Component content,
                                    CAction... actions) {
     ...
     *                A separator is inserted for every entry that is <code>null</code> of this array.
     */
    public DefaultMultipleCDockable(MultipleCDockableFactory<?, ?> factory, Icon icon, String title,
                                    Component content, CAction... actions) {
     ...
     */
    public DefaultMultipleCDockable(MultipleCDockableFactory<?, ?> factory, Icon icon, String title,
                                    Component content, Permissions permissions, CAction... actions) {
     ...
     *                     A separator is inserted for every entry that is <code>null</code> of this array.
     */
    public DefaultMultipleCDockable(MultipleCDockableFactory<?, ?> factory, Icon icon, IconHandling iconHandling,
                                    String title, Component content, Permissions permissions, CAction... actions) {
