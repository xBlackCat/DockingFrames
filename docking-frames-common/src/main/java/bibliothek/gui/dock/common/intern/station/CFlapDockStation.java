...
public class CFlapDockStation extends FlapDockStation implements CommonDockStation<FlapDockStation, CFlapDockStation> {
    private final CommonStationDelegate<CFlapDockStation> delegate;
    private final Component expansion;
    private final CHoldActionHandler actionHandler = new CHoldActionHandler();
     ...
     * {@link Dockable}s. This listener is responsible for reading the action
     * {@link CDockable#ACTION_KEY_MINIMIZE_HOLD}.
     *
     * @author Benjamin Sigg
     */
