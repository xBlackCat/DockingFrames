...
public class FontMap {
     ...
     */
    private final Map<String, FontModifier> fonts = new HashMap<>();

    /**
     * listeners to be informed when {@link #fonts} changes
     */
    private final List<FontMapListener> listeners = new ArrayList<>();
                ...
                if (italic || bold) {
                    ...
                    if ("+".equals(entryValue)) {
                        ...
                        throw new IllegalArgumentException(
                                "illegal value, must be one of '+', '-' or '!': " + modification);
                    }
    ...
    public void setFont(String key, FontModifier font) {
        ...
        if ((old == null && font != null) || (old != null && !old.equals(font))) {
            for (FontMapListener listener : listeners.toArray(new FontMapListener[0])) {
