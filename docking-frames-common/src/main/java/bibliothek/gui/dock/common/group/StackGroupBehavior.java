 ...
 * This behavior does not move around entire {@link StackDockStation}s, it moves around each {@link Dockable}
 * individually.
...
public class StackGroupBehavior implements CGroupBehavior {
    public CGroupMovement prepare(LocationModeManager<? extends LocationMode> manager, Dockable dockable,
                                  ExtendedMode target) {
    ...
    public Dockable getGroupElement(LocationModeManager<? extends LocationMode> manager, Dockable dockable,
                                    ExtendedMode mode) {
        DockStation parent = dockable.getDockParent();
    ...
    public Dockable getReplaceElement(LocationModeManager<? extends LocationMode> manager, Dockable old,
                                      Dockable dockable, ExtendedMode mode) {
        if (old == dockable) {
            return null;
        }
    ...
    public boolean shouldForwardActions(LocationModeManager<? extends LocationMode> manager, DockStation station,
                                        Dockable dockable, ExtendedMode mode) {
