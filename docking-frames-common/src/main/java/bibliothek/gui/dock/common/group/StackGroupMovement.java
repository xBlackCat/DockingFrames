...
public class StackGroupMovement implements CGroupMovement {
    private final StackDockStation dockParent;
    private final Dockable dockable;
    private final ExtendedMode target;
    ...
    public void apply(CGroupBehaviorCallback callback) {
        ...
        for (int i = baseIndex - 1; i >= 0; i--) {
            ...
            Location movingLocation =
                    new Location(base.getMode(), base.getRoot(), copyAndSetStackLocation(base.getLocation(),
                            i - baseIndex + 1 - missing), true);
