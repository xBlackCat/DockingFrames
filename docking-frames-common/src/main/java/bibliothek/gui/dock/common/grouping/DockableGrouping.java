...
public interface DockableGrouping {
     ...
     *
     * @param dockable an invisible dockable that is about to be made visible, and that does not have a location
     *                 defined.
     ...
     * This method is allowed to return an invalid location, invalid locations however will be replaced with valid
     * location.
     */
     ...
     * @param mode             the target mode for <code>dockable</code>
     * @param validatedHistory a validated location. This may be the result of
     * {@link #getStoredLocation(Dockable, CLocationMode, Location)}
     *                         if that result already was a valid location, or it may be a new location, may be
     *                         <code>null</code>
     * @return either <code>validatedHistory</code>, or a newly created location. Also <code>null</code> is a valid
     * result.
     * This method should return only valid locations, invalid locations will lead the framework to place the
     * dockable at some
     * default location
     */
    ...
    /**
     * Always called after <code>dockable</code> has changed its location. This method will be called for any
     * {@link Dockable} that
     * changed its location, even if {@link #getStoredLocation(Dockable, CLocationMode, Location)} or
     * {@link #getValidatedLocation(Dockable, CLocationMode, Location)}
     * was never called.<br>
