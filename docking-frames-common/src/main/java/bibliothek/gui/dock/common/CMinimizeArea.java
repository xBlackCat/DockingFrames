...
/**
 * An area where {@link CDockable}s can be stored in their minimized state. This class is a subclass of
 * {@link JPanel} and
...
public class CMinimizeArea extends JPanel implements CStation<CFlapDockStation> {
    ...
    protected void init(CControl control, String uniqueId) {
        ...
        station = control.getFactory().createFlapDockStation(this, new CommonStationDelegate<>() {
