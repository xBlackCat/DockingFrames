...
public class ThemeMap {
     ...
     */
    private final List<ThemeMapListener> listeners = new ArrayList<>();
    ...
    private void init(CControl control) {
        ThemeFactory flat =
                new CDockThemeFactory<>(new ThemePropertyFactory<>(FlatTheme.class), control) {
                    @Override
        ...
        ThemeFactory bubble =
                new CDockThemeFactory<>(new ThemePropertyFactory<>(BubbleTheme.class), control) {
                    @Override
                    public DockTheme create(CControl control) {
        ...
        ThemeFactory eclipse = new CDockThemeFactory<>(new ThemePropertyFactory<>(EclipseTheme.class), control) {
            @Override
            public DockTheme create(CControl control) {
        ...
        ThemeFactory smooth =
                new CDockThemeFactory<>(new ThemePropertyFactory<>(SmoothTheme.class), control) {
                    @Override
                    public DockTheme create(CControl control) {
        ...
        ThemeFactory basic =
                new CDockThemeFactory<>(new ThemePropertyFactory<>(BasicTheme.class), control) {
                    @Override
                    public DockTheme create(CControl control) {
    ...
    protected ThemeMapListener[] listeners() {
        return listeners.toArray(new ThemeMapListener[0]);
    }
