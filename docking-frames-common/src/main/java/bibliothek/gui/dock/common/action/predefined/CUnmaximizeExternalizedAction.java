...
public class CUnmaximizeExternalizedAction extends CExtendedModeAction {
    ...
    public CUnmaximizeExternalizedAction(CControl control) {
        super(control, ExtendedMode.EXTERNALIZED, CLocationModeManager.ICON_MANAGER_KEY_UNMAXIMIZE_EXTERNALIZED,
                "maximize_externalized.out", "maximize_externalized.out.tooltip", CControl.KEY_GOTO_EXTERNALIZED);
    }
}
