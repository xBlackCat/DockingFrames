...
public class CMinimizePerspective implements CStationPerspective {
     ...
     */
    private final CModeAreaPerspective mode = new CModeAreaPerspective() {
    ...
    public void setPerspective(CPerspective perspective) {
        if (this.perspective != null) {
            CMinimizedModePerspective mode =
                    (CMinimizedModePerspective) this.perspective.getLocationManager().getMode(ExtendedMode.MINIMIZED);
