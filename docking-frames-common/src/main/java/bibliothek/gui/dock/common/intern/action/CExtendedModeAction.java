...
public class CExtendedModeAction extends CDropDownItem<CExtendedModeAction.Action> {
     ...
     */
    protected CExtendedModeAction(CControl control, ExtendedMode mode, String iconKey, String textKey,
                                  String tooltipKey, PropertyKey<KeyStroke> gotoStroke) {
        super(null);
        init(control, mode, iconKey, textKey, tooltipKey, gotoStroke);
    }

    /**
     * Creates an empty, non initialized action. Subclasses must call
     * {@link #init(CControl, ExtendedMode, String, String, String, PropertyKey)} to
     ...
     * @param gotoStroke the key to the {@link KeyStroke} that triggers this action
     */
    protected void init(CControl control, ExtendedMode mode, String iconKey, String textKey, String tooltipKey,
