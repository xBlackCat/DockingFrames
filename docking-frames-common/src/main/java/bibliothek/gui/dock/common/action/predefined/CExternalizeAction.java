...
public class CExternalizeAction extends CExtendedModeAction {
    ...
    public CExternalizeAction(CControl control) {
        super(control, ExtendedMode.EXTERNALIZED, CLocationModeManager.ICON_MANAGER_KEY_EXTERNALIZE, "externalize.in"
                , "externalize.in.tooltip", CControl.KEY_GOTO_EXTERNALIZED);
    }
}
