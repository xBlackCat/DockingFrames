...
public class CommonSingleTabDecider implements SingleTabDecider {
    private final List<SingleTabDeciderListener> listeners = new ArrayList<>();
    private final CControl control;

    private final CDockablePropertyListener dockableListener = new CDockableAdapter() {
        @Override
    ...
    protected SingleTabDeciderListener[] listeners() {
        return listeners.toArray(new SingleTabDeciderListener[0]);
    }
