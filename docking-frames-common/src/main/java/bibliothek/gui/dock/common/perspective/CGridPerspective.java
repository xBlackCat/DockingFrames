...
import bibliothek.gui.dock.common.perspective.mode.*;
...
public class CGridPerspective extends SingleCDockablePerspective implements CStationPerspective {
     ...
     */
    private final CommonSplitDockPerspective delegate;
     ...
     */
    private final CModeAreaPerspective normalMode = new CModeAreaPerspective() {
     ...
     */
    private final CMaximizedModeAreaPerspective maximalMode = new CMaximizedModeAreaPerspective() {
        public String getUniqueId() {
            return CGridPerspective.this.getUniqueId();
        }
     ...
     * @param id          the unique identifier of this perspective
     * @param typeId      the type of this station, can be <code>null</code>
     * @param workingArea whether this station should be treated as {@link CStation#isWorkingArea() working area} or
     *                       not.
     */
     ...
     * is like removing all children and add them again with
     * {@link #gridAdd(double, double, double, double, CDockablePerspective...)}.
     *
     ...
     * @param width        the width of <code>dockables</code>, can be any number greater than 0
     * @param height       the height of <code>dockables</code>, can be any number greater than 0
     * @param placeholders the placeholders to add, should contain at least one element and no <code>null</code>
     *                        elements
     * @throws IllegalArgumentException if not all dockables have a placeholder
     * @see #gridClear()
     * @see #gridDeploy()
     ...
     * in a group of dockables. This method does not change the layout directly, but a call to {@link #gridDeploy()}
     * will.
     *
     * @param x         the x-coordinate of <code>dockables</code>, can be any number
     * @param y         the y-coordinate of <code>dockables</code>, can be any number
     ...
     * In particular this method analyzes all the commands that were generated by calls to the <code>grid*</code>
     * methods
    ...
    /**
     * Maximized <code>dockable</code> on this station. Please read about the side effects in
     * {@link #maximize(PerspectiveDockable)}.
     *
