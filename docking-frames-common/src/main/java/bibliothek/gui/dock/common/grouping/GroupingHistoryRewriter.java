...
/**
 * This {@link HistoryRewriter} gets the current {@link CGroupingBehavior} using the key
 * {@link CControl#GROUPING_BEHAVIOR}
 * from its {@link CControl}. It then accesses the {@link DockableGrouping} of a {@link Dockable} to rewrite its
 * history.
...
public class GroupingHistoryRewriter implements HistoryRewriter<Location, CLocationMode> {
     ...
     */
    private final HistoryRewriter<Location, CLocationMode> validation;
