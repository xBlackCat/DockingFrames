...
public interface CssTransitionCallback {
     ...
     */
    <T> CssPropertyKey[] getPropertiesOfType(CssType<T> type);
     ...
     */
    <T> void setProperty(CssType<T> type, CssPropertyKey key, T value);
     ...
     */
    <T> T getProperty(CssType<T> type, CssPropertyKey key);
     ...
     */
    void addSourceDependency(String key, CssProperty<?> property);
     ...
     */
    void removeSourceDependency(String key);
     ...
     * @param property the property to automatically set
     */
    void addTargetDependency(String key, CssProperty<?> property);
     ...
     * @param key the name of the property to remove
     */
    void removeTargetDependency(String key);
}
