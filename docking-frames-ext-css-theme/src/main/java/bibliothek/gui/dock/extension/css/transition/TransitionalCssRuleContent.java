...
public interface TransitionalCssRuleContent extends CssRuleContent {
     ...
     * {@link TransitionalCssRuleContent}. Note that if several transitions are nested, then the root rule is not the
     * previous
     ...
     */
    void inserted(RuleChainLink link);
     ...
     */
    boolean isAnimated(CssPropertyKey property);
    ...
    /**
     * Starts an additional transition on this rule.
     * {@link CssTransition#init(CssRuleContent, CsstransitionCallback)} should
     ...
     */
    void animate(CssPropertyKey transitionKey, CssTransition<?> transition);
     ...
     */
    void transition(CssRuleContent root);
