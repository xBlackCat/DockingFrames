...
public class DefaultCssRule implements CssRule, CssRuleContent {
     ...
     */
    private final List<CssRuleListener> listeners = new ArrayList<>(2);

    /**
     * all the listeners that have been added to this rule-content
     */
    private final List<CssRuleContentListener> contentListeners = new ArrayList<>(2);

    /**
     * all the properties of this rule
     */
    private final Map<CssPropertyKey, CssDeclarationValue> properties = new HashMap<>(5);
    ...
    public void setSelector(CssSelector selector) {
        ...
        for (CssRuleListener listener : listeners.toArray(new CssRuleListener[0])) {
    ...
    public void setProperty(CssPropertyKey key, CssDeclarationValue value) {
        ...
        for (CssRuleContentListener listener : contentListeners.toArray(new CssRuleContentListener[0])) {
