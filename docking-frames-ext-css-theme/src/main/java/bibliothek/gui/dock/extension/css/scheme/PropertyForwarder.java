...
public class PropertyForwarder {
     ...
     */
    private final CssRuleContent source;

    /**
     * where to insert all the values
     */
    private final CssPropertyContainer target;
     ...
     */
    private final Map<CssPropertyKey, CssProperty<?>> properties = new HashMap<>();
    ...
    protected CssPropertyKey[] getKeys() {
        return properties.keySet().toArray(new CssPropertyKey[0]);
    }
