...
public interface RuleChainLinkListener {
     ...
     */
    void previousChanged(RuleChainLink source, RuleChainLink oldPrevious, RuleChainLink newPrevious);
     ...
     */
    void nextChanged(RuleChainLink source, RuleChainLink oldNext, RuleChainLink newNext);
     ...
     */
    void removed(RuleChainLink source);
}
