...
@CssDocPathNode(
        ...
        pseudoClasses = {
                @CssDocKey(key = "fullscreen", description = @CssDocText(text = "Applied if the child is in " +
                        "fullscreen mode")),
...
public class ScreenDockStationNode extends AbstractCssNode {
    ...
    private final ScreenDockStationListener fullscreenListener = new ScreenDockStationListener() {
        @Override
    ...
    private final DockStationListener boundaryListener = new DockStationAdapter() {
        @Override
