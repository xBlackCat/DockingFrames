...
public class WrappedCssRuleContent implements CssRuleContent {
    ...
    private final List<CssRuleContentListener> listeners = new ArrayList<>();

    private final CssRuleContentListener forwardListener = new CssRuleContentListener() {
        @Override
    ...
    private CssRuleContentListener[] listeners() {
        return listeners.toArray(new CssRuleContentListener[0]);
    }
