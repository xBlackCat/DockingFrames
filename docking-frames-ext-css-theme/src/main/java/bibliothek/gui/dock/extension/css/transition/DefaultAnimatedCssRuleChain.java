...
public class DefaultAnimatedCssRuleChain implements TransitionalCssRuleChain {
    ...
    private class Link implements RuleChainLink {
        private final List<RuleChainLinkListener> listeners = new ArrayList<>(2);
        private final TransitionalCssRuleContent rule;
        ...
        private RuleChainLinkListener[] listeners() {
            return listeners.toArray(new RuleChainLinkListener[0]);
        }
    }
}
