...
public class TransitionalCssFontModifierProperty extends AbstractTransitionalCssProperty<CssFontModifier> {
    ...
    protected void update() {
        ...
        if ((source == null || source instanceof GenericCssFontModifier) &&
                (target == null || target instanceof GenericCssFontModifier)) {
    ...
    private record CombinedCssFont(FontModifier delegate) implements CssFontModifier {
