...
/**
 * This {@link TransitionalCssProperty} handles objects of type {@link CssPropertyContainer}, it automatically
 * requests and
 * handles the sub-properties:
 * <ul>
 * 	<li>Properties related to the <code>source</code> <code>T</code> are registered as dependency of the old
 *    {@link CssRule}.</li>
 * 	<li>Properties related to the <code>target</code> <code>T</code> are registered as dependency of the new
 *    {@link CssRule}.</li>
 *  <li>Properties related to the resulting <code>T</code> are handled by
 *  {@link TransitionalCssPropertyCallback#set(Object)}</li>
 * </ul>
 *
