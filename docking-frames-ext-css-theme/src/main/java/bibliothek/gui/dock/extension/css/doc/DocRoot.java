...
public class DocRoot implements Iterable<DocPackage> {
     ...
     */
    private final Map<String, DocPackage> packages = new HashMap<>();

    private final Map<String, DocClass> cache = new HashMap<>();
    ...
    public Iterator<DocPackage> iterator() {
        List<DocPackage> result = new ArrayList<>(packages.values());
