...
/**
 * This {@link CssFontModifier} makes use of a {@link GenericFontModifier} to change size, italic and boldness of a
 * font.
 *
...
public class GenericCssFontModifier implements CssFontModifier {
     ...
     */
    private final List<CssFontModifierListener> listeners = new ArrayList<>(2);

    /**
     * the actual algorithm
     */
    private final GenericFontModifier delegate = new GenericFontModifier();

    /**
     * default value for {@link #italic}
     */
    private final Modify defaultItalic = Modify.IGNORE;

    /**
     * whether the font should be italic
     */
    private final FontModifyCssProperty italic = new FontModifyCssProperty() {
        @Override
     ...
     */
    private final Modify defaultBold = Modify.IGNORE;

    /**
     * whether the font should be bold
     */
    private final FontModifyCssProperty bold = new FontModifyCssProperty() {
        @Override
        public void set(Modify value) {
            if (value == null) {
                value = defaultBold;
     ...
     */
    private final IntegerCssProperty size = new IntegerCssProperty() {
        @Override
     ...
     */
    private final int defaultDelta = 0;
     ...
     */
    private final IntegerCssProperty delta = new IntegerCssProperty() {
        @Override
        public void set(Integer value) {
            if (value == null) {
                value = defaultDelta;
