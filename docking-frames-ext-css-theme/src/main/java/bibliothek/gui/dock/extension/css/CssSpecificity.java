...
public class CssSpecificity implements Comparable<CssSpecificity> {
    ...
    /**
     * @param style              1 if the declaration is from is a 'style' attribute rather than a rule with a
     *                           selector, 0 otherwise (= a)
     *                           (In HTML, values of an element's "style" attribute are style sheet rules. These
