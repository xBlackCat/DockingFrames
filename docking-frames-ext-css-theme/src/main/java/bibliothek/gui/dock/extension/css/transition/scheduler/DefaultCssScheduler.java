...
public class DefaultCssScheduler implements CssScheduler {
    ...
    private final PriorityQueue<Call> queue = new PriorityQueue<>();
    private final Map<CssSchedulable, Call> calls = new HashMap<>();

    private volatile int pendingCalls = 0;
    private volatile Call executing;

    private final ActionListener callback = e -> step();
    ...
    private class Call implements Comparable<Call> {
        ...
        private final long nanoScheduled;
        ...
        public Call(CssSchedulable job, int delay) {
            ...
            nanoScheduled = nanoStart + 1000000L * delay;
        }
