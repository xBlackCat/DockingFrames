...
public class DockElementPath extends AbstractCssPath {
    ...
    private final DockHierarchyListener hierarchyListener = new DockHierarchyListener() {
        @Override
    ...
    private final CssPathListener parentListener = path -> firePathChanged();

    private final CssNodeListener nodeListener = node -> firePathChanged();
