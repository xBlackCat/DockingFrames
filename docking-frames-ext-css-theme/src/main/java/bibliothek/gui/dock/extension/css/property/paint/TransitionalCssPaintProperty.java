...
public class TransitionalCssPaintProperty extends AbstractTransitionalCssProperty<CssPaint> {
    ...
    private record FadedPaint(CssPaint source, CssPaint target, float transition) implements CssPaint {
        ...
        public String toString() {
            return getClass().getSimpleName() + "[source=" + source + ", target=" + target + ", transition=" +
                    transition + "]";
        }
    }
}
