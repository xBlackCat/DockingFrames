...
public interface CssPropertyContainerListener {
     ...
     */
    void propertyAdded(CssPropertyContainer source, String key, CssProperty<?> property);
     ...
     */
    void propertyRemoved(CssPropertyContainer source, String key, CssProperty<?> property);
}
