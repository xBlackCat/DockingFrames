...
public interface CssPropertyContainer {
     ...
     */
    CssProperty<?> getProperty(String key);
     ...
     */
    void addPropertyContainerListener(CssPropertyContainerListener listener);
     ...
     */
    void removePropertyContainerListener(CssPropertyContainerListener listener);
