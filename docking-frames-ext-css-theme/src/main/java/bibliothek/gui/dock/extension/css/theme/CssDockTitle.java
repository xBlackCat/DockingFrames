...
import bibliothek.gui.dock.extension.css.doc.*;
...
public class CssDockTitle extends AbstractDockTitle {
    private final CssScheme css;

    private final DefaultCssNode self;
    ...
    @CssDocPath(id = "self",
            ...
            nodes = {@CssDocPathNode(
                    ...
                    pseudoClasses = {
                            @CssDocKey(key = "selected", description = @CssDocText(text = "Applied if the title is " +
                                    "selected"))},
                    properties = {
                            @CssDocKey(key = "side", description = @CssDocText(text = "Depends on the orientation of " +
                                    "the title, one of 'east', 'west', 'south', 'north' or 'free'")),
                            @CssDocKey(key = "horizontal", description = @CssDocText(text = "'true' if the title is " +
                                    "horizontal")),
                            @CssDocKey(key = "vertical", description = @CssDocText(text = "'true' if the title is " +
                                    "vertical")),
