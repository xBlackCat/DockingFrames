...
public interface EclipseThemeConnector {
     ...
     */
    TitleBar getTitleBarKind(DockStation parent, Dockable dockable);

    /**
     * Tells whether <code>action</code> should be shown on the right side of the
     * tab of <code>dockable</code>.<br>
     * Note that {@link #shouldShowOnSide(DockAction, EclipseTabStateInfo)} and
     * {@link #shouldShowOnTab(DockAction, EclipseTabStateInfo)}
