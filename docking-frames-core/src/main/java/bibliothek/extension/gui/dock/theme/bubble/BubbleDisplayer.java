...
public class BubbleDisplayer extends BasicDockableDisplayer {
    ...
    private final DisplayerColor borderHighActive =
            new BubbleDisplayerColor("displayer.border.high.active", Color.WHITE);
    private final DisplayerColor borderHighActiveMouse =
            new BubbleDisplayerColor("displayer.border.high.active.mouse", Color.WHITE);
    private final DisplayerColor borderHighInactive =
            new BubbleDisplayerColor("displayer.border.high.inactive", Color.DARK_GRAY);
    private final DisplayerColor borderHighInactiveMouse =
            new BubbleDisplayerColor("displayer.border.high.inactive.mouse", Color.DARK_GRAY);
    private final DisplayerColor borderHighDisabled =
            new BubbleDisplayerColor("displayer.border.high.disabled", Color.WHITE);
    private final DisplayerColor borderLowActive =
            new BubbleDisplayerColor("displayer.border.low.active", Color.LIGHT_GRAY);
    private final DisplayerColor borderLowActiveMouse =
            new BubbleDisplayerColor("displayer.border.low.active.mouse", Color.LIGHT_GRAY);
    private final DisplayerColor borderLowInactive =
            new BubbleDisplayerColor("displayer.border.low.inactive", Color.BLACK);
    private final DisplayerColor borderLowInactiveMouse =
            new BubbleDisplayerColor("displayer.border.low.inactive.mouse", Color.BLACK);
    private final DisplayerColor borderLowDisabled =
            new BubbleDisplayerColor("displayer.border.low.disabled", Color.LIGHT_GRAY);
     ...
     */
    private final DisplayerBorder openBorder;
    ...
    public class OpenBorder implements Border {
        public Insets getBorderInsets(Component c) {
            ...
            return switch (getTitleLocation()) {
                case BOTTOM -> new Insets(borderSize, borderSize, 0, borderSize);
                case LEFT -> new Insets(borderSize, 0, borderSize, borderSize);
                case RIGHT -> new Insets(borderSize, borderSize, borderSize, 0);
                case TOP -> new Insets(0, borderSize, borderSize, borderSize);
            };
        }
