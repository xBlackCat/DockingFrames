...
public class KeyStrokeEditor extends JTextField implements PreferenceEditor<KeyStroke> {
     ...
     */
    public static final PreferenceEditorFactory<KeyStroke> FACTORY = KeyStrokeEditor::new;
    ...
    public static boolean isModifierKey(int keyCode) {
        return switch (keyCode) {
            case KeyEvent.VK_ALT, KeyEvent.VK_ALT_GRAPH, KeyEvent.VK_CONTROL, KeyEvent.VK_SHIFT, KeyEvent.VK_META ->
                    true;
            default -> false;
        };
    }
