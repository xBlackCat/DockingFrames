...
public class RoundButton extends JComponent implements RoundButtonConnectable {
    ...
    private final BasicButtonModel model;

    private final AbstractDockColor[] colors;
     ...
     */
    public RoundButton(BasicTrigger trigger, BasicResourceInitializer initializer, Dockable dockable,
                       DockAction action) {
        setFocusable(true);
