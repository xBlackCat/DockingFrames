 ...
 * global {@link TabPainter} which in respect is made available by the {@link DockProperties} and the key
 * {@link EclipseTheme#TAB_PAINTER}.
 *
 * @author Janni Kovacs
 * @author Benjamin Sigg
 */
public class NoTitleBarDisplayer extends BasicDockableDisplayer implements DockableDisplayer, InvisibleTabPane,
                                                                           BorderedComponent {
    private final PropertyValue<TabPainter> painter;

    private final TitleBarObserver observer;
    ...
    private final DisplayerBorder innerBorderModifier = new DisplayerBorder("in");
    private final DisplayerBorder outerBorderModifier = new DisplayerBorder("out");
    ...
    public NoTitleBarDisplayer(DockStation station, Dockable dockable, DockTitle title, TitleBar bar) {
        ...
        painter = new PropertyValue<>(EclipseTheme.TAB_PAINTER) {
            @Override
