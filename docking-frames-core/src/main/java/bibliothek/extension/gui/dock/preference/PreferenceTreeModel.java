...
public class PreferenceTreeModel extends AbstractPreferenceModel implements TreeModel {
     ...
     */
    private final MergedPreferenceModel delegate;

    /**
     * a listener to <code>delegate</code>
     */
    private final PreferenceModelListener delegateListener = new PreferenceModelListener() {
    ...
    private final List<TreeModelListener> treeListeners = new ArrayList<>();

    private final TreeNode root = new TreeNode(null, new Path());
    ...
    protected TreeModelListener[] getTreeModelListeners() {
        return treeListeners.toArray(new TreeModelListener[0]);
    }
    ...
    private class TreeNode implements Node {
        ...
        private final PreferenceModelText name;
