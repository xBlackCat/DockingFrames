...
public class PreferenceOperation {
    ...
    private class View implements PreferenceOperationView {
        private final List<PreferenceOperationViewListener> listeners = new ArrayList<>();

        private final PreferenceOperationIcon icon;

        private final PreferenceOperationText description;
