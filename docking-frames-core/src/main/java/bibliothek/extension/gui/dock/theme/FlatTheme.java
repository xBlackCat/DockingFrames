 ...
 */
@ThemeProperties(nameBundle = "theme.flat", descriptionBundle = "theme.flat.description", authors = {
        "Benjamin Sigg"}, webpages = {})
public class FlatTheme extends BasicTheme {
    ...
    public static final PropertyKey<ColorScheme> FLAT_COLOR_SCHEME =
            new PropertyKey<>("dock.ui.FlatTheme.ColorScheme", new DynamicPropertyFactory<>() {
    ...
    public static final PropertyKey<DockActionDistributor> ACTION_DISTRIBUTOR =
            new PropertyKey<>("flat.DockActionDistributor",
    ...
    public FlatTheme() {
        ...
        setStackDockComponentFactory(FlatTabPane::new, Priority.DEFAULT);
