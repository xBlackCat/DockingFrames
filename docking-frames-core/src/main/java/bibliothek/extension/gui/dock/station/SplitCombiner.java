...
public class SplitCombiner extends BasicCombiner {
    ...
    public Dockable combine(CombinerSource source, CombinerTarget target) {
        if (target instanceof Target splitTarget) {
     ...
     * @author Benjamin Sigg
     */
    private record Target(DockStation station, Location side, double space) implements CombinerTarget {
        /**
        ...
        public void paint(Graphics g, Component component, StationPaint paint, Rectangle stationBounds,
            ...
            switch (side) {
                case TOP -> destination.height = (int) (destination.height * space);
                case BOTTOM -> {
                    destination.height = (int) (destination.height * space);
                    destination.y += dockableBounds.height - destination.height;
                }
                case LEFT -> destination.width = (int) (destination.width * space);
                case RIGHT -> {
