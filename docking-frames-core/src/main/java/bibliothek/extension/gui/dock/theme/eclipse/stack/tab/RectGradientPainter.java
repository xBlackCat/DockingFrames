    ...
    public void paintBackground(Graphics g) {
        ...
        if (isSelected) {
            ...
            if (getTransparency() != Transparency.TRANSPARENT) {
                switch (orientation) {
                    case TOP_OF_DOCKABLE -> g.fillRect(0, 0, getWidth(), getHeight() - 1);
                    case BOTTOM_OF_DOCKABLE -> g.fillRect(0, 1, getWidth(), getHeight() - 1);
                    case LEFT_OF_DOCKABLE -> g.fillRect(0, 0, getWidth() - 1, getHeight());
                    case RIGHT_OF_DOCKABLE -> g.fillRect(1, 0, getWidth() - 1, getHeight());
                }
            }
        }
