 ...
 */
@ColorCodes({"stack.tab.border", "stack.tab.border.selected", "stack.tab.border.selected.focused",
...
public class DefaultInvisibleTab implements InvisibleTab {
    ...
    private final WindowActiveObserver observer = new WindowActiveObserver();
    ...
    private final DockableFocusListener focusListener = new DockableFocusListener() {
