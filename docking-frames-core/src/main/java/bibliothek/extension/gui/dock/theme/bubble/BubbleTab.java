...
public class BubbleTab extends ConfiguredBackgroundPanel implements CombinedTab, StackDockComponentListener, Runnable
        , DockableFocusListener {
    /**
     * a label showing text and icon for this tab
     */
    private final OrientedLabel label = new OrientedLabel();

    /**
     * a panel showing additional actions on this tab
     */
    private final ButtonPanel actions = new ButtonPanel(false);
     ...
     */
    private final TabComponentLayoutManager layoutManager;

    /**
     * an animation used when the mouse enters or leaves this tab
     */
    private final BubbleColorAnimation animation;
    /**
     ...
     * parent component
     */
    private final BubbleStackDockComponent parent;

    /**
     * all the {@link MouseListener} that were added
     */
    private final List<MouseInputListener> mouseInputListeners = new ArrayList<>();
    ...
    private final BubbleTabColor topMouse;
    private final BubbleTabColor bottomMouse;
    private final BubbleTabColor borderMouse;
    private final BubbleTabColor textMouse;

    private final BubbleTabColor top;
    private final BubbleTabColor bottom;
    private final BubbleTabColor border;
    private final BubbleTabColor text;

    private final BubbleTabColor topSelectedMouse;
    private final BubbleTabColor bottomSelectedMouse;
    private final BubbleTabColor borderSelectedMouse;
    private final BubbleTabColor textSelectedMouse;

    private final BubbleTabColor topSelected;
    private final BubbleTabColor bottomSelected;
    private final BubbleTabColor borderSelected;
    private final BubbleTabColor textSelected;

    private final BubbleTabColor topFocusedMouse;
    private final BubbleTabColor bottomFocusedMouse;
    private final BubbleTabColor borderFocusedMouse;
    private final BubbleTabColor textFocusedMouse;

    private final BubbleTabColor topFocused;
    private final BubbleTabColor bottomFocused;
    private final BubbleTabColor borderFocused;
    private final BubbleTabColor textFocused;

    private final BubbleTabColor topDisabled;
    private final BubbleTabColor bottomDisabled;
    private final BubbleTabColor borderDisabled;
    private final BubbleTabColor textDisabled;

    private final BubbleTabColor[] colors;

    private final BubbleTabFont fontFocused;
    private final BubbleTabFont fontSelected;
    private final BubbleTabFont fontUnselected;
    ...
    public BubbleTab(BubbleStackDockComponent parent, Dockable dockable) {
        ...
        topMouse =
                new BubbleTabColor(STATE_MOUSE, "stack.tab.background.top.mouse", "top", animation, dockable,
                        Color.RED.brighter());
        bottomMouse =
                new BubbleTabColor(STATE_MOUSE, "stack.tab.background.bottom.mouse", "bottom", animation, dockable,
                        Color.RED.darker());
        borderMouse =
                new BubbleTabColor(STATE_MOUSE, "stack.tab.border.mouse", "border", animation, dockable,
                        Color.RED.darker().darker());
        textMouse =
                new BubbleTabColor(STATE_MOUSE, "stack.tab.foreground.mouse", "text", animation, dockable, Color.BLACK);

        top = new BubbleTabColor(0, "stack.tab.background.top", "top", animation, dockable, Color.RED.brighter());
        bottom =
                new BubbleTabColor(0, "stack.tab.background.bottom", "bottom", animation, dockable, Color.RED.darker());
        ...
        topSelectedMouse = new BubbleTabColor(STATE_SELECTED |
                STATE_MOUSE, "stack.tab.background.top.selected.mouse", "top", animation, dockable,
                Color.RED.brighter());
        bottomSelectedMouse = new BubbleTabColor(STATE_SELECTED |
                STATE_MOUSE, "stack.tab.background.bottom.selected.mouse", "bottom", animation, dockable,
                Color.RED.darker());
        borderSelectedMouse = new BubbleTabColor(STATE_SELECTED |
                STATE_MOUSE, "stack.tab.border.selected.mouse", "border", animation, dockable,
                Color.RED.darker().darker());
        textSelectedMouse = new BubbleTabColor(STATE_SELECTED |
                STATE_MOUSE, "stack.tab.foreground.selected.mouse", "text", animation, dockable, Color.BLACK);

        topSelected =
                new BubbleTabColor(STATE_SELECTED, "stack.tab.background.top.selected", "top", animation, dockable,
                        Color.RED.brighter());
        bottomSelected =
                new BubbleTabColor(STATE_SELECTED, "stack.tab.background.bottom.selected", "bottom", animation,
                        dockable, Color.RED.darker());
        borderSelected =
                new BubbleTabColor(STATE_SELECTED, "stack.tab.border.selected", "border", animation, dockable,
                        Color.RED.darker().darker());
        textSelected =
                new BubbleTabColor(STATE_SELECTED, "stack.tab.foreground.selected", "text", animation, dockable,
                        Color.BLACK);

        topFocusedMouse = new BubbleTabColor(STATE_FOCUSED |
                STATE_MOUSE, "stack.tab.background.top.focused.mouse", "top", animation, dockable,
                Color.RED.brighter());
        bottomFocusedMouse = new BubbleTabColor(STATE_FOCUSED |
                STATE_MOUSE, "stack.tab.background.bottom.focused.mouse", "bottom", animation, dockable,
                Color.RED.darker());
        borderFocusedMouse = new BubbleTabColor(STATE_FOCUSED |
                STATE_MOUSE, "stack.tab.border.focused.mouse", "border", animation, dockable,
                Color.RED.darker().darker());
        textFocusedMouse = new BubbleTabColor(STATE_FOCUSED |
                STATE_MOUSE, "stack.tab.foreground.focused.mouse", "text", animation, dockable, Color.BLACK);

        topFocused =
                new BubbleTabColor(STATE_FOCUSED, "stack.tab.background.top.focused", "top", animation, dockable,
                        Color.RED.brighter());
        bottomFocused =
                new BubbleTabColor(STATE_FOCUSED, "stack.tab.background.bottom.focused", "bottom", animation,
                        dockable, Color.RED.darker());
        borderFocused =
                new BubbleTabColor(STATE_FOCUSED, "stack.tab.border.focused", "border", animation, dockable,
                        Color.RED.darker().darker());
        textFocused =
                new BubbleTabColor(STATE_FOCUSED, "stack.tab.foreground.focused", "text", animation, dockable,
                        Color.BLACK);

        topDisabled =
                new BubbleTabColor(STATE_DISABLED, "stack.tab.background.top.disabled", "top", animation, dockable,
                        Color.LIGHT_GRAY.brighter());
        bottomDisabled =
                new BubbleTabColor(STATE_DISABLED, "stack.tab.background.bottom.disabled", "bottom", animation,
                        dockable, Color.LIGHT_GRAY.darker());
        borderDisabled =
                new BubbleTabColor(STATE_DISABLED, "stack.tab.border.disabled", "border", animation, dockable,
                        Color.LIGHT_GRAY.darker().darker());
        textDisabled =
                new BubbleTabColor(STATE_DISABLED, "stack.tab.foreground.disabled", "text", animation, dockable,
                        Color.BLACK);
    ...
    public void paintBackground(Graphics g) {
        if (getTransparency() != Transparency.TRANSPARENT) {
            ...
            g2.setColor(border);
            switch (orientation) {
                case TOP_OF_DOCKABLE -> g2.fillRoundRect(0, 0, w, h + arc, 2 * arc, 2 * arc);
                case BOTTOM_OF_DOCKABLE -> g2.fillRoundRect(0, -arc, w, h + arc, 2 * arc, 2 * arc);
                case LEFT_OF_DOCKABLE -> g2.fillRoundRect(0, 0, w + arc, h, 2 * arc, 2 * arc);
                case RIGHT_OF_DOCKABLE -> g2.fillRoundRect(-arc, 0, w + arc, h, 2 * arc, 2 * arc);
            }
            ...
            switch (orientation) {
                case TOP_OF_DOCKABLE -> g2.fillRoundRect(borderSize, borderSize,
                        w - 2 * borderSize, h + arc - borderSize, 2 * arc, 2 * arc);
                case BOTTOM_OF_DOCKABLE ->
                        g2.fillRoundRect(borderSize, -arc, w - 2 * borderSize, h + arc - borderSize, 2 * arc, 2 * arc);
                case LEFT_OF_DOCKABLE -> g2.fillRoundRect(borderSize, borderSize,
                        w + arc - borderSize, h - 2 * borderSize, 2 * arc, 2 * arc);
    ...
    public void paintOverlay(Graphics g) {
        ...
        switch (orientation) {
            case TOP_OF_DOCKABLE -> g2.setClip(new RoundRectangle2D.Float(0, 0, w, h + arc, 2 * arc, 2 * arc));
            case BOTTOM_OF_DOCKABLE -> g2.setClip(new RoundRectangle2D.Float(0, -arc, w, h + arc, 2 * arc, 2 * arc));
            case LEFT_OF_DOCKABLE -> g2.setClip(new RoundRectangle2D.Float(0, 0, w + arc, h, 2 * arc, 2 * arc));
            case RIGHT_OF_DOCKABLE -> g2.setClip(new RoundRectangle2D.Float(-arc, 0, w + arc, h, 2 * arc, 2 * arc));
        }
