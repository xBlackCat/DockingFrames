...
public class ChoiceDockPropertyPreference<V> extends DefaultPreference<String> {
    private final DockProperties properties;
    private final PropertyKey<V> key;
    private final DefaultChoice<V> choice;
     ...
     */
    public ChoiceDockPropertyPreference(DockProperties properties, PropertyKey<V> key, Path path,
