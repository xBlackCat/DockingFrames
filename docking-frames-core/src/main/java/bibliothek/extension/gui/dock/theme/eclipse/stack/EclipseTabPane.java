...
public class EclipseTabPane extends CombinedStackDockComponent<EclipseTab, EclipseMenu, EclipseTabInfo> implements BorderedComponent {
    ...
    private final PropertyValue<TabPainter> tabPainter = new PropertyValue<>(EclipseTheme.TAB_PAINTER) {
        @Override
    ...
    private final PropertyValue<Boolean> paintIcons = new PropertyValue<>(EclipseTheme.PAINT_ICONS_WHEN_DESELECTED) {
        @Override
    ...
    @Override
    protected CombinedStackDockContentPane createContentPane(CombinedStackDockComponent<EclipseTab, EclipseMenu,
            EclipseTabInfo> self) {
    ...
    private class TabContentBorder extends BorderForwarder implements StackDockComponentContentBorder {
        ...
        public TabContentBorder(Dockable dockable, JComponent target) {
            super(StackDockComponentContentBorder.KIND,
                    ThemeManager.BORDER_MODIFIER + ".stack.eclipse.content", target);
