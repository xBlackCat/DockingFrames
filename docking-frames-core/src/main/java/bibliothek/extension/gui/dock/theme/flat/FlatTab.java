...
public class FlatTab extends ConfiguredBackgroundPanel implements CombinedTab, DockableFocusListener {
     ...
     */
    private final FlatTabPane pane;
     ...
     */
    private final Background backgroundAlgorithm = new Background();
    ...
    private final TabColor borderSelectedOut;
    private final TabColor borderSelectedCenter;
    private final TabColor borderFocusedOut;
    private final TabColor borderFocusedCenter;
    private final TabColor borderOut;
    private final TabColor borderCenter;
    private final TabColor borderDisabledOut;
    private final TabColor borderDisabledCenter;
    private final TabColor border;
    private final TabColor backgroundSelectedTop;
    private final TabColor backgroundSelectedBottom;
    private final TabColor backgroundFocusedTop;
    private final TabColor backgroundFocusedBottom;
    private final TabColor backgroundTop;
    private final TabColor backgroundBottom;
    private final TabColor backgroundDisabledTop;
    private final TabColor backgroundDisabledBottom;
    private final TabColor background;
    private final TabColor foreground;
    private final TabColor foregroundSelected;
    private final TabColor foregroundFocused;
    private final TabColor foregroundDisabled;

    private final TabFont fontFocused;
    private final TabFont fontSelected;
    private final TabFont fontUnselected;
