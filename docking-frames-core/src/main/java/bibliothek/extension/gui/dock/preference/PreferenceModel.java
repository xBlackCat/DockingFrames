 ...
 *  <li>With a call to {@link PreferenceStorage#load(PreferenceModel, boolean)} the artificial and natural
 *  preferences are loaded.</li>
 ...
 *  <li>Using one of the <code>write</code>-methods of the {@link PreferenceStorage} the client can store the
 *  preferences persistently</li>
 * </ol>
 * Note that many {@link PreferenceModel}s can share the same {@link PreferenceStorage}. In such a case its best to
 * re-create and refill the
