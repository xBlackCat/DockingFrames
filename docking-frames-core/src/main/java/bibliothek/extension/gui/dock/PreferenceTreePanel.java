...
public class PreferenceTreePanel extends JPanel {
    ...
    private final PreferenceTable table;
    ...
    public PreferenceTreePanel(PreferenceTreeModel model) {
        ...
        tree =
                new JTree(Objects.requireNonNullElseGet(model, () -> new DefaultTreeModel(new DefaultMutableTreeNode(
                        "<null>"))));
        ...
        tree.addTreeSelectionListener(e -> checkSelection());
