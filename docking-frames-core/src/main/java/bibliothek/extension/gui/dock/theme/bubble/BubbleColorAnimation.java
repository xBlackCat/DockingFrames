 ...
 * can call {@link #getColor(String)} any time to get the current intermediate color. Adding a
 * {@link #addTask(Runnable) task}
...
public class BubbleColorAnimation {
     ...
     */
    private final Map<String, Entry> colors = new HashMap<>();
    /**
