...
public class OwnedRectEclipseBorder extends RectEclipseBorder {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if (placement != null) {
            switch (placement) {
                case TOP_OF_DOCKABLE -> setRoundEdges(TOP_LEFT | TOP_RIGHT);
                case BOTTOM_OF_DOCKABLE -> setRoundEdges(BOTTOM_LEFT | BOTTOM_RIGHT);
                case LEFT_OF_DOCKABLE -> setRoundEdges(BOTTOM_LEFT | TOP_LEFT);
                case RIGHT_OF_DOCKABLE -> setRoundEdges(BOTTOM_RIGHT | TOP_RIGHT);
            }
        }
