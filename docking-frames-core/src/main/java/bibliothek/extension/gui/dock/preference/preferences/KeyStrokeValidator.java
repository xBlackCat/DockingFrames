...
public interface KeyStrokeValidator {
     ...
     */
    KeyStrokeValidator EVERYTHING = new KeyStrokeValidator() {
     ...
     */
    KeyStrokeValidator NO_MODIFIER = new KeyStrokeValidator() {
        public boolean isValid(KeyStroke keyStroke) {
     ...
     */
    KeyStrokeValidator MODIFIER = new KeyStrokeValidator() {
        public boolean isValid(KeyStroke keyStroke) {
            return KeyStrokeEditor.isModifierKey(keyStroke.getKeyCode());
        }
