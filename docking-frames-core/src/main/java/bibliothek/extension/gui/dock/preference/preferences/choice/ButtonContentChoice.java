...
public class ButtonContentChoice extends DefaultChoice<ButtonContent> {
    ...
    public ButtonContentChoice(DockProperties properties) {
        ...
        addLinked("itto", "preference.layout.choice.ButtonContent.icon_then_text_only",
                ButtonContent.ICON_THEN_TEXT_ONLY);
        addLinked("ttio", "preference.layout.choice.ButtonContent.text_then_icon_only",
        ...
        addLinked("ita", "preference.layout.choice.ButtonContent.icon_and_text_actions",
                ButtonContent.ICON_AND_TEXT_ACTIONS);
        addLinked("itta", "preference.layout.choice.ButtonContent.icon_then_text_actions",
