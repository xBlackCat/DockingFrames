...
public class PreferenceTable extends JPanel {
     ...
     */
    private final Map<Path, PreferenceEditorFactory<?>> factories = new HashMap<>();
     ...
     */
    private final List<PreferenceOperation> operations = new ArrayList<>();

    /**
     * all the views that are currently in use
     */
    private final Map<PreferenceOperation, Operation> operationViews = new HashMap<>();
    ...
    private class Operation {
        private final PreferenceOperation operation;
    ...
    private class Row<V> implements PreferenceEditorCallback<V> {
        ...
        private final PreferenceEditor<V> editor;
        ...
        private class Button extends BasicMiniButton implements PreferenceOperationViewListener {
            ...
            private final PreferenceOperationView view;
            ...
            public void descriptionChanged(PreferenceOperationView operation, String oldDescription,
