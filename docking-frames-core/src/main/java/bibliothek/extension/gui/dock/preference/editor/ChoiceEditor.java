 ...
 */
public class ChoiceEditor extends JComboBox<ChoiceEditor.Entry> implements PreferenceEditor<String> {
    /**
     * a factory creating new {@link ChoiceEditor}s
     */
    public static final PreferenceEditorFactory<String> FACTORY = ChoiceEditor::new;
     ...
     */
    private final ChoiceListener listener = new ChoiceListener() {
        public void updated(Choice choice, int indexStart, int indexEnd) {
            ...
            for (int i = indexStart; i <= indexEnd; i++) {
                Entry entry = model.getElementAt(i + delta);
    ...
    private void checkOperations() {
        if (callback != null && choice != null) {
            ...
            boolean enabled = (value == null && choice.getDefaultChoice() != null) ||
                    (value != null && !value.equals(choice.getDefaultChoice()));
    ...
    public void setValue(String value) {
        try {
            ...
            for (int i = 0, n = model.getSize(); i < n; i++) {
                Entry entry = model.getElementAt(i);
                if (Objects.equals(value, entry.id)) {
     ...
     * @author Benjamin Sigg
     */
    private static class Model extends DefaultComboBoxModel<Entry> {
        /**
