...
public class BubbleButtonDockTitle extends AbstractBubbleDockTitle {
    ...
    public void setOrientation(Orientation orientation) {
        switch (orientation) {
            case SOUTH_SIDED, NORTH_SIDED, FREE_HORIZONTAL -> orientation = Orientation.FREE_HORIZONTAL;
            case EAST_SIDED, WEST_SIDED, FREE_VERTICAL -> orientation = Orientation.FREE_VERTICAL;
        }
