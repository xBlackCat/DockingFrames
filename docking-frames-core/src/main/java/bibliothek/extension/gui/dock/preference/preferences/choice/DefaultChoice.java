...
public class DefaultChoice<V> implements Choice {
     ...
     */
    private final List<ChoiceListener> listeners = new ArrayList<>();
    ...
    public DefaultChoice(DockController controller) {
        if (controller != null) {
            ExtensionName<ChoiceExtension> name = new ExtensionName<>(
    ...
    private ChoiceListener[] listeners() {
        return listeners.toArray(new ChoiceListener[0]);
    }
