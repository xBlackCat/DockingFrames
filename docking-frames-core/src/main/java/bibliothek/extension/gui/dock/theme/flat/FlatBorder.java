...
public class FlatBorder implements Border {
     ...
     */
    private final DockableDisplayer owner;

    private final BorderColor background = new BorderColor("displayer.border");
    private final BorderColor light = new BorderColor("displayer.border.light");
    private final BorderColor dark = new BorderColor("displayer.border.dark");
    private final BorderColor middle = new BorderColor("displayer.border.middle");
