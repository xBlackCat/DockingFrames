...
public class BubbleColorScheme extends DefaultColorScheme {
    ...
    private Color color(Distribution distribution, int p, int s, int t) {
        return switch (distribution) {
            case BGR -> new Color(t, s, p);
            case BRG -> new Color(s, t, p);
            case GBR -> new Color(t, p, s);
            case GRB -> new Color(s, p, t);
            case RBG -> new Color(p, t, s);
            case RGB -> new Color(p, s, t);
            default -> new Color(p, s, t);
        };
    }
}
