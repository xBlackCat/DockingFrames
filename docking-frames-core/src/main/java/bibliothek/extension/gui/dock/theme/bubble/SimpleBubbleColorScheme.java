...
import static bibliothek.util.Colors.*;
...
public class SimpleBubbleColorScheme extends DefaultColorScheme {
    ...
    public static final SimpleBubbleColorScheme BLOPS =
            new SimpleBubbleColorScheme(Color.BLACK, Color.WHITE, new Color(100, 255, 100), new Color(255, 100, 100),
                    Color.DARK_GRAY, 0.3, 0.6, 0.9);
    ...
    public static final SimpleBubbleColorScheme BRIGHT =
            new SimpleBubbleColorScheme(Color.LIGHT_GRAY, Color.WHITE, new Color(200, 200, 200), new Color(200, 200,
                    255), new Color(100, 100, 100), 0.3, 0.6, 0.9);
    ...
    public static final ColorScheme LOOK_AND_FEEL =
            new AbstractColorScheme() {
                ...
                private final UISchemeListener<Color, DockColor, ColorBridge> delegateListener =
                        event -> fire(new UISchemeEvent<>() {
     ...
     */
    public SimpleBubbleColorScheme(Color active, Color inactive, Color enabled, Color selected, Color disabled,
                                   double factorWeak, double factor, double factorStrong) {
        this(active, inactive, enabled, selected, disabled, diffMirror(active, 1.0), diffMirror(inactive, 1.0),
                factorWeak, factor, factorStrong);
    }
     ...
     */
    public SimpleBubbleColorScheme(Color active, Color inactive, Color enabled, Color selected, Color disabled,
                                   Color activeText, Color inactiveText, double factorWeak, double factor,
                                   double factorStrong) {
        // stack        
        ...
        setColor("action.button.pressed.selected.enabled.focus", undiffMirror(diffMirror(selected, factorStrong),
                factorWeak));
        ...
        setColor("action.dropdown.selected.focus", diffMirror(middle(disabled, middle(selected, disabled)),
                factorWeak));
        ...
        setColor("action.dropdown.mouse.selected.enabled.focus", undiffMirror(diffMirror(selected, factor),
                factorWeak));
        setColor("action.dropdown.pressed.enabled.focus", undiffMirror(diffMirror(enabled, factorStrong), factorWeak));
        setColor("action.dropdown.pressed.selected.enabled.focus", undiffMirror(diffMirror(selected, factorStrong),
                factorWeak));
        ...
        setColor("action.dropdown.line.pressed.selected.enabled", undiffMirror(diffMirror(selected, factorStrong),
                factorWeak));
