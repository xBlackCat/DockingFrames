...
public interface PreferenceFactory<V> {
     ...
     */
    PreferenceFactory<Boolean> FACTORY_BOOLEAN = new PreferenceFactory<>() {
     ...
     */
    PreferenceFactory<Integer> FACTORY_INT = new PreferenceFactory<>() {
     ...
     */
    PreferenceFactory<String> FACTORY_STRING = new PreferenceFactory<>() {
     ...
     */
    PreferenceFactory<KeyStroke> FACTORY_KEYSTROKE = new PreferenceFactory<>() {
     ...
     */
    PreferenceFactory<ModifierMask> FACTORY_MODIFIER_MASK = new PreferenceFactory<>() {
