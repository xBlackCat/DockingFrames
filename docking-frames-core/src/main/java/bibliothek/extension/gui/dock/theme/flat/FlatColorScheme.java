...
public class FlatColorScheme extends DefaultColorScheme {
    ...
    protected void updateUI() {
        ...
        setColor("title.flap.active.knob.highlight",
                Colors.brighter(DockUI.getColor(LookAndFeelColors.TITLE_SELECTION_BACKGROUND)));
        setColor("title.flap.active.knob.shadow",
                Colors.darker(DockUI.getColor(LookAndFeelColors.TITLE_SELECTION_BACKGROUND)));
        ...
        setColor("title.flap.inactive.knob.highlight",
                Colors.brighter(DockUI.getColor(LookAndFeelColors.TITLE_BACKGROUND)));
        ...
        setColor("title.flap.selected.knob.highlight",
                Colors.brighter(DockUI.getColor(LookAndFeelColors.TITLE_BACKGROUND)));
