...
public class BubbleTheme extends BasicTheme {
    ...
    public static final PropertyKey<ColorScheme> BUBBLE_COLOR_SCHEME =
            new PropertyKey<>("dock.ui.BubbleTheme.ColorScheme",
    ...
    public static final PropertyKey<DockActionDistributor> ACTION_DISTRIBUTOR =
            new PropertyKey<>("dock.bubble.DockActionDistributor",
                    new ConstantPropertyFactory<>(new DefaultDockActionDistributor()), true);

    /**
     * the {@link DockController}s which currently use this theme
     */
    private final List<DockController> controllers = new ArrayList<>();
    ...
    public BubbleTheme() {
        ...
        setStackDockComponentFactory(BubbleStackDockComponent::new, Priority.DEFAULT);
    ...
    public void install(DockController controller) {
        ...
        controller.getIcons().setScheme(Priority.THEME, new DefaultIconScheme("data/bibliothek/gui/dock/core/bubble" +
                "/icons.ini", BubbleTheme.class.getClassLoader(), controller));
    ...
    private static class CheckGenerator implements ViewGenerator<SelectableDockAction, BasicTitleViewItem<JComponent>> {
        public BasicTitleViewItem<JComponent> create(ActionViewConverter converter, SelectableDockAction action,
                                                     Dockable dockable) {
    ...
    private static class DropDownGenerator implements ViewGenerator<DropDownAction, BasicTitleViewItem<JComponent>> {
        public BasicTitleViewItem<JComponent> create(ActionViewConverter converter, DropDownAction action,
                                                     Dockable dockable) {
    ...
    private static class MenuGenerator implements ViewGenerator<MenuDockAction, BasicTitleViewItem<JComponent>> {
        public BasicTitleViewItem<JComponent> create(ActionViewConverter converter, MenuDockAction action,
                                                     Dockable dockable) {
    ...
    private static class SeparatorGenerator implements ViewGenerator<SeparatorAction, BasicTitleViewItem<JComponent>> {
        public BasicTitleViewItem<JComponent> create(ActionViewConverter converter, SeparatorAction action,
                                                     Dockable dockable) {
