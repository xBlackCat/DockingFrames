...
public class DefaultDockableSelection extends AbstractDockableSelection {
    ...
    private final JList<Dockable> list;
    ...
    public DefaultDockableSelection() {
        ...
        list.addListSelectionListener(e -> setSelection(list.getSelectedValue()));
     ...
     * @author Benjamin Sigg
     */
    private static class Model extends DefaultListModel<Dockable> {
    ...
    private static class Renderer extends DefaultListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list,
            ...
            if (value instanceof Dockable dockable) {
