...
public class DockFocusTraversalPolicy extends FocusTraversalPolicy {
    ...
    public Component getComponentAfter(Container container, Component component) {
        ...
        try {
            ...
            while (true) {
                ...
                if (next instanceof Container nextContainer) {
    ...
    public Component getComponentBefore(Container container, Component component) {
        ...
        try {
            ...
            while (true) {
                ...
                if (previous instanceof Container previousContainer) {
                    if (!previousContainer.isFocusCycleRoot() && previousContainer.isFocusTraversalPolicyProvider()) {
                        ...
                        if (circle) {
                            ...
                            selected =
                                    previousContainer.getFocusTraversalPolicy().getDefaultComponent(previousContainer);
                        }
    ...
    public Component getDefaultComponent(Container container) {
        ...
        try {
            ...
            if (component instanceof Container ccontainer) {
