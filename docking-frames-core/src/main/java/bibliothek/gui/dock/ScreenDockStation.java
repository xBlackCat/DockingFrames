...
import bibliothek.gui.dock.station.screen.magnet.*;
import bibliothek.gui.dock.station.screen.window.*;
...
public class ScreenDockStation extends AbstractDockStation {
    ...
    public static final PropertyKey<BoundaryRestriction> BOUNDARY_RESTRICTION =
            new PropertyKey<>("ScreenDockStation.boundary_restriction",
                    new ConstantPropertyFactory<>(BoundaryRestriction.MEDIUM), true);
    ...
    public static final PropertyKey<ScreenDockWindowFactory> WINDOW_FACTORY =
            new PropertyKey<>("ScreenDockStation.window_factory",
                    new ConstantPropertyFactory<>(new DefaultScreenDockWindowFactory()), true);
    ...
    public static final PropertyKey<ScreenDockWindowClosingStrategy> WINDOW_CLOSING_STRATEGY =
            new PropertyKey<>("ScreenDockStation.window_closing");
    ...
    public static final PropertyKey<ScreenDockWindowConfiguration> WINDOW_CONFIGURATION =
            new PropertyKey<>("ScreenDockStation.window_configuration",
                    new PropertyFactory<>() {
    ...
    public static final PropertyKey<ScreenDockFullscreenStrategy> FULL_SCREEN_STRATEGY =
            new PropertyKey<>("ScreenDockStation.full_screen_strategy",
                    new PropertyFactory<>() {
    ...
    public static final PropertyKey<Boolean> EXPAND_ON_DOUBLE_CLICK =
            new PropertyKey<>("ScreenDockStation.double_click_fullscreen", new ConstantPropertyFactory<>(true), true);

    /**
     * time in milliseconds a {@link ScreenDockWindow} is prevented from stealing the focus after the
     * {@link #getOwner() owner} of this station changed. A value
    ...
    public static final PropertyKey<Integer> PREVENT_FOCUS_STEALING_DELAY =
            new PropertyKey<>("ScreenDockStation.prevent_focus_stealing_delay", new ConstantPropertyFactory<>(500),
                    false);
    ...
    public static final PropertyKey<MagnetStrategy> MAGNET_STRATEGY =
            new PropertyKey<>("ScreenDockStation.magnet_strategy",
                    new ConstantPropertyFactory<>(new DefaultMagnetStrategy()) {
    ...
    public static final PropertyKey<AttractorStrategy> ATTRACTOR_STRATEGY =
            new PropertyKey<>("ScreenDockStation.attractor_strategy", new DynamicPropertyFactory<>() {
                public AttractorStrategy getDefault(PropertyKey<AttractorStrategy> key, DockProperties properties) {
                    ExtensionName<AttractorStrategy> name =
                            new ExtensionName<>(ATTRACTOR_STRATEGY_EXTENSION, AttractorStrategy.class, null);
    ...
    public static final PropertyKey<ScreenDropSizeStrategy> DROP_SIZE_STRATEGY =
            new PropertyKey<>("ScreendockStation.drop_size_strategy",
                    new ConstantPropertyFactory<>(ScreenDropSizeStrategy.CURRENT_SIZE), true);
     ...
     */
    private final List<ScreenDockStationListener> screenDockStationListeners = new ArrayList<>();
     ...
     */
    private final PropertyValue<BoundaryRestriction> restriction =
            new PropertyValue<>(ScreenDockStation.BOUNDARY_RESTRICTION) {
                @Override
     ...
     */
    private final PropertyValue<ScreenDockWindowFactory> windowFactory =
            new PropertyValue<>(ScreenDockStation.WINDOW_FACTORY) {
                @Override
     ...
     */
    private final PropertyValue<ScreenDockWindowConfiguration> windowConfiguration =
            new PropertyValue<>(ScreenDockStation.WINDOW_CONFIGURATION) {
                @Override
                protected void valueChanged(ScreenDockWindowConfiguration oldValue,
                                            ScreenDockWindowConfiguration newValue) {
                    updateWindows(true);
                }
            };
     ...
     */
    private final PropertyValue<ScreenDockFullscreenStrategy> fullscreenStrategy =
            new PropertyValue<>(ScreenDockStation.FULL_SCREEN_STRATEGY) {
                @Override
                protected void valueChanged(ScreenDockFullscreenStrategy oldValue,
                                            ScreenDockFullscreenStrategy newValue) {
                    List<ScreenDockWindow> fullscreenWindows = new ArrayList<>();
     ...
     */
    private final PropertyValue<Boolean> expandOnDoubleClick =
            new PropertyValue<>(EXPAND_ON_DOUBLE_CLICK) {
                @Override
    ...
    private final PropertyValue<PlaceholderStrategy> placeholderStrategy =
            new PropertyValue<>(PlaceholderStrategy.PLACEHOLDER_STRATEGY) {
                @Override
     ...
     */
    private final PropertyValue<ScreenDropSizeStrategy> dropSizeStrategy = new PropertyValue<>(DROP_SIZE_STRATEGY) {
        @Override
     ...
     */
    private final List<ScreenDockFullscreenFilter> filters = new ArrayList<>();

    /**
     * all the {@link FullscreenActionSource}s that are currently used
     */
    private final List<FullscreenActionSource> filterSources = new LinkedList<>();
    ...
    protected ScreenDockStationListener[] screenDockStationListeners() {
        return screenDockStationListeners.toArray(new ScreenDockStationListener[0]);
    }
    ...
    public DockActionSource getDirectActionOffers(Dockable dockable) {
        if (fullscreenAction == null) {
            ...
            return createFullscreenSource(dockable, new LocationHint(LocationHint.DIRECT_ACTION,
    ...
    public DockActionSource getIndirectActionOffers(Dockable dockable) {
        ...
        return createFullscreenSource(dockable, new LocationHint(LocationHint.INDIRECT_ACTION,
                LocationHint.VERY_RIGHT));
    }
    ...
    public void setController(DockController controller) {
        ...
        if (controller != null) {
            ...
            List<ScreenDockStationExtension> list =
                    controller.getExtensions().load(new ExtensionName<>(STATION_EXTENSION,
                            ScreenDockStationExtension.class, EXTENSION_PARAM, this));
            extensions = list.toArray(new ScreenDockStationExtension[0]);
        } else {
            extensions = null;
        }
    ...
    public void setPlaceholders(PlaceholderMap placeholders) {
        ...
        try {
            DockablePlaceholderList<ScreenDockWindowHandle> next = new DockablePlaceholderList<>(placeholders);
    ...
    public void setPlaceholders(PlaceholderMap map, final Map<Integer, Dockable> children) {
        ...
        try {
            ...
            DockablePlaceholderList<ScreenDockWindowHandle> next = new DockablePlaceholderList<>();
            ...
            next.read(map, new PlaceholderListItemAdapter<>() {
    ...
    public void aside(AsideRequest request) {
        ...
        if (location instanceof ScreenDockProperty screenLocation) {
    ...
    public Dockable[] getFullscreenChildren() {
        ...
        return result.toArray(new Dockable[0]);
    }
    ...
    public void move(Dockable dockable, DockableProperty property) {
        DockUtilities.checkLayoutLocked();
        if (property instanceof ScreenDockProperty bounds) {
            ScreenDockWindow window = getWindow(dockable);
            if (window == null) {
                throw new IllegalArgumentException("dockable not child of this station");
            }
            ...
            if (!boundsIncludeWindow) {
                ...
                if (offset != null) {
                    ...
                    windowBounds = new Rectangle(
                            windowBounds.x + offset.x,
                            windowBounds.y + offset.y, windowBounds.width, windowBounds.height);
        ...
        if (placeholder != null) {
            ...
            if (handle != null) {
                ...
                if (meta != null) {
                    ...
                    ScreenDockProperty replacement =
                            new ScreenDockProperty(x, y, width, height, placeholder, property.isFullscreen());
    ...
    private boolean executeDrop(ScreenDockStationExtension.DropArguments args) {
        ...
        if (best != null && best.getDockable() != null) {
            ...
            if (!done) {
                ...
                if (old.accept(this, dockable) && dockable.accept(this, old) &&
                        (acceptance == null || acceptance.accept(this, old, dockable))) {
        ...
        if (!done) {
            boolean accept = accept(dockable) && dockable.accept(this) &&
                    (acceptance == null || acceptance.accept(this, dockable));
            if (accept) {
                addDockable(dockable, new Rectangle(property.getX(), property.getY(), property.getWidth(),
                        property.getHeight()), property.getPlaceholder(), args.isBoundsIncludeWindow());
                done = true;
            }
        }
    ...
    protected ScreenDockWindowHandle register(Dockable dockable, Path placeholder, ScreenDockWindow window,
        ...
        if (placeholder != null) {
            if (dockables.getDockableAt(placeholder) != null) {
                throw new IllegalStateException("there is already a window in the group " + placeholder + ", add the " +
     ...
     * by new windows created by
     * {@link ScreenDockWindowFactory#updateWindow(ScreenDockWindow, WindowConfiguration, ScreenDockStation)}.
     */
    ...
    /**
     * Update all windows either by calling
     * {@link ScreenDockWindowFactory#updateWindow(ScreenDockWindow, WindowConfiguration, ScreenDockStation)}
     * or by calling {@link ScreenDockWindowFactory#createWindow(ScreenDockStation, WindowConfiguration)}.
     *
     * @param force if <code>true</code>, then
     * {@link ScreenDockWindowFactory#createWindow(ScreenDockStation, WindowConfiguration) createWindow}
     *              is used and all windows are replaced, if <code>false</code> the factory is allowed to do
     *              optimizations.
     */
            ...
            if (newWindow != null && newWindow != oldWindow) {
                ...
                if (visible && isShowing()) {
                    if (delay == null || delay <= 0) {
                        ...
                        newWindow.setVisible(true);
                        Timer timer = new Timer(delay, e -> newWindow.setPreventFocusStealing(false));
    ...
    @Deprecated
    @Todo(compatibility = Compatibility.BREAK_MAJOR, priority = Priority.ENHANCEMENT, target = Version.VERSION_1_1_3,
