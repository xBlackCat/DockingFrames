...
public interface DockFactory<D extends DockElement, P extends PerspectiveElement, L> extends DockConverter<D, P, L> {
     ...
     *                 {@link DockLayoutInfo#setLocation(DockableProperty)} or
     *                 {@link LocationEstimationMap#setLocation(int, DockableProperty)} and
     *                 {@link LocationEstimationMap#setLocation(int, int, DockableProperty)} for as many children as
     *                 possible
     */
     ...
     * @return the new element, can be <code>null</code>, the return value of
     * {@link PerspectiveElement#getFactoryID()} should
