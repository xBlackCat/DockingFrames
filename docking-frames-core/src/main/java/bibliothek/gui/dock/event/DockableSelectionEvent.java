...
public class DockableSelectionEvent {
    ...
    private final Dockable oldSelected;
    private final Dockable newSelected;
     ...
     */
    public DockableSelectionEvent(DockController controller, DockStation station, Dockable oldSelected,
