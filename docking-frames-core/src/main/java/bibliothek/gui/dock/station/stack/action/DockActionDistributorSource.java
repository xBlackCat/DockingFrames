...
public class DockActionDistributorSource extends AbstractDockActionSource {
    private final DockActionDistributor.Target target;
     ...
     */
    private final DockHierarchyListener listener = new DockHierarchyListener() {
     ...
     */
    private final PropertyValue<DockActionDistributor> distributor =
            new PropertyValue<>(new PropertyKey<>("dock.empty")) {
                @Override
     ...
     */
    private final DockActionSourceListener actionListener = new DockActionSourceListener() {
