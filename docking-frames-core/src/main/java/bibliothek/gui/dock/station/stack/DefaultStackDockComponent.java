...
public class DefaultStackDockComponent extends JTabbedPane implements StackDockComponent {
     ...
     */
    private final List<Tab> dockables = new ArrayList<>();
    ...
    public void setDockTabPlacement(TabPlacement tabSide) {
        switch (tabSide) {
            case BOTTOM_OF_DOCKABLE -> setTabPlacement(BOTTOM);
            case LEFT_OF_DOCKABLE -> setTabPlacement(LEFT);
            case TOP_OF_DOCKABLE -> setTabPlacement(TOP);
            case RIGHT_OF_DOCKABLE -> setTabPlacement(RIGHT);
        }
    }
    ...
    /**
     * The structure of the {@link JTabbedPane} does not allow its tabs to recognized as
     * {@link DockElementRepresentative},
     ...
     * @author Benjamin Sigg
     */
    public static class Tab extends ActionPopup {
        /**
         * the element on the tab
         */
        protected final Dockable dockable;
        /**
            ...
            if (mouseTarget != null && mouseTarget.relocator != null) {
                ...
                switch (reaction) {
                    ...
                    case CONTINUE_CONSUMED:
                        // consume MouseEvent in all cases: there will never be any component below the tab that
                        // should start
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (mouseTarget != null && mouseTarget.relocator != null) {
                ...
                switch (reaction) {
                    ...
                    case CONTINUE_CONSUMED -> e.consume();
                }
            } else {
                updateRelocator(e.getX(), e.getY(), true, true);
                if (mouseTarget != null) {
