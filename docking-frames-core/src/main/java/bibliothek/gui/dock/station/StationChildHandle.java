...
public class StationChildHandle implements PlaceholderListItem<Dockable> {
    ...
    /**
     * Creates a new handle, initializes a {@link DockTitleRequest} but no {@link DockableDisplayer} nor a
     * {@link DockTitle}. This
     * constructor also adds a {@link DockableListener} to <code>dockable</code> to update the title whenever
     * <code>dockable</code>
     * requests it.<br>
     ...
     */
    public StationChildHandle(DockStation station, DisplayerCollection displayers, Dockable dockable,
