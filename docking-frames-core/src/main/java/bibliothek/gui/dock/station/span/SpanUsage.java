...
public class SpanUsage {
    /**
     * Marks a {@link Span} that usually has a size of <code>0</code> and is made larger for an invisible
     * {@link DockStation} to show up
     */
    public static final SpanUsage HIDING = new SpanUsage();

    /**
     * Marks a {@link Span} that shows up when inserting a {@link Dockable} at a specific place, e.g. between two
     * existing {@link Dockable}s
     */
