...
public enum TabPlacement {
    ...
    public Orientation toOrientation() {
        return switch (this) {
            case TOP_OF_DOCKABLE -> Orientation.NORTH_SIDED;
            case BOTTOM_OF_DOCKABLE -> Orientation.SOUTH_SIDED;
            case LEFT_OF_DOCKABLE -> Orientation.WEST_SIDED;
            case RIGHT_OF_DOCKABLE -> Orientation.EAST_SIDED;
