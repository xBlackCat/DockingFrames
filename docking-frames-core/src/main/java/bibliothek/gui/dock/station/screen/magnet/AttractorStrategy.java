...
public interface AttractorStrategy {
     ...
     */
    Attraction attract(ScreenDockStation parent, Dockable moved, Dockable fixed);
     ...
     * @see Attraction how <code>fixed</code> and <code>moved</code> interact
     */
    Attraction stick(ScreenDockStation parent, Dockable moved, Dockable fixed);
}
