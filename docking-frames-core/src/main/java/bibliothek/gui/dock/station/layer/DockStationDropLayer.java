...
public interface DockStationDropLayer {
     ...
     * @return either <code>child</code> or a new {@link DockStationDropLayer} replacing <code>child</code>, not
     * <code>null</code>
     */
    ...
    /**
     * Compares this level with <code>level</code>. This method is only called if
     * {@link #canCompare(DockStationDropLayer)}
