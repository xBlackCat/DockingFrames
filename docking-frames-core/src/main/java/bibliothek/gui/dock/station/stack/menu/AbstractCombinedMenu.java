...
public abstract class AbstractCombinedMenu extends AbstractTabPaneComponent implements CombinedMenu {
     ...
     */
    private final PropertyValue<CombinedMenuContent> content = new PropertyValue<>(
     ...
     */
    private final CombinedHandler<? super AbstractCombinedMenu> handler;

    /**
     * All the listeners that were added to this menu
     */
    private final List<TabMenuListener> listeners = new ArrayList<>();
    ...
    protected TabMenuListener[] tabMenuListeners() {
        return listeners.toArray(new TabMenuListener[0]);
    }
    ...
    private class Handler implements CombinedMenuContentListener {
        private final CombinedMenuContent menu;
