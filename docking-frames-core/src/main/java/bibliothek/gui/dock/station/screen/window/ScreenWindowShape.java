...
public interface ScreenWindowShape {
    ...
    /**
     * Called by the {@link ScreenDockWindow} if its size has changed, can lead to a call to
     * {@link ScreenWindowShapeCallback#setShape(java.awt.Shape)}
     */
    void onResize();

    /**
     * Called by the {@link ScreenDockWindow} if it was made visible, can lead to a call to
     * {@link ScreenWindowShapeCallback#setShape(java.awt.Shape)}
     */
    void onShown();
}
