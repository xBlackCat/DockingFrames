...
public class PlaceholderMap {
     ...
     */
    private final Map<Key, Map<String, Object>> data = new LinkedHashMap<>();
     ...
     */
    private final PlaceholderStrategyListener listener = placeholders -> removeAll(placeholders, false);
     ...
     * equal to any key that is generated by this method using the same arguments.
     *
     * @param anchor       if the anchor is set, then this key cannot be automatically deleted. It is the clients
     *                     responsibility
     *                     to ensure that no two keys have the same anchor. If two keys have the same anchor, then
     *                     one of them might override
    ...
    public void validate(PlaceholderStrategy strategy, boolean recursive) {
        ...
        Key[] keys = data.keySet().toArray(new Key[0]);
        for (Key key : keys) {
    ...
    public void add(Key placeholder) {
        ...
        Map<String, Object> map = data.computeIfAbsent(placeholder, k -> new LinkedHashMap<>());
    }
     ...
     *                                  {@link PlaceholderMap} nor an array of {@link Object}s containing the
    ...
    public void put(Key placeholder, String key, Object value) {
        ...
        if (invalid == null) {
            ...
            throw new IllegalArgumentException(
                    "value of illegal type: " + (invalid instanceof String ? invalid : invalid.getClass()));
        }
    }
     ...
     * @author Benjamin Sigg
     */
    private static class PlaceholderKey implements Key {
         ...
         * Creates a new key.
         *
         * @param anchor       the anchor, makes this key accessible even if all placeholders are deleted, can be
         *                     <code>null</code>
