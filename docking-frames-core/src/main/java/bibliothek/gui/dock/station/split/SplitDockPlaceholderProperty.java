...
public class SplitDockPlaceholderProperty extends AbstractDockableProperty {
    ...
    public String toString() {
        return getClass().getSimpleName() + "[placeholder=" + getPlaceholder() + ", backup=" + getBackup() +
    ...
    public SplitDockProperty toSplitLocation(SplitNode target) {
        ...
        SplitDockProperty result =
                new SplitDockProperty(target.getX(), target.getY(), target.getWidth(), target.getHeight());
    ...
    public SplitDockPlaceholderProperty copy() {
        SplitDockPlaceholderProperty copy =
                new SplitDockPlaceholderProperty(placeholder, backup == null ? null : backup.copy());
        copy(copy);
        return copy;
    }
    ...
    public void load(DataInputStream in) throws IOException {
        ...
        switch (in.readByte()) {
            ...
            default -> throw new IllegalArgumentException("unknown type of backup property");
        }
    }
