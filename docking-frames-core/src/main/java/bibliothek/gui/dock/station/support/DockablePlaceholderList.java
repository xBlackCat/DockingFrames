 ...
 */
public class DockablePlaceholderList<P extends PlaceholderListItem<Dockable>> extends PlaceholderList<Dockable,
        DockStation, P> {
    ...
    /**
     * Simulates a call to {@link #read(PlaceholderMap, PlaceholderListItemConverter)} and makes all calls to
     * <code>converter</code>
    ...
    public static <P extends PlaceholderListItem<Dockable>> void simulatedRead(PlaceholderMap map,
                                                                               PlaceholderListItemConverter<Dockable,
                                                                                       P> converter) {
        DockablePlaceholderList<P> list = new DockablePlaceholderList<>();
