...
public interface ScreenDockStationExtension {
     ...
     */
    void drop(ScreenDockStation station, DropArguments arguments);
     ...
     */
    void dropped(ScreenDockStation station, DropArguments arguments, boolean successful);

    /**
     * A class offering all the arguments of the method
     * {@link ScreenDockStation#drop(Dockable, ScreenDockProperty, boolean)}
     *
     * @author Benjamin Sigg
     */
    class DropArguments {
