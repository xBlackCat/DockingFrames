 ...
 */
public class FlapDockStationFactory implements DockFactory<FlapDockStation, FlapDockPerspective,
    ...
    public void setLayout(FlapDockStation station, FlapDockStationLayout layout, Map<Integer, Dockable> children,
        ...
        try {
            ...
            if (layout instanceof RetroFlapDockStationLayout retroLayout) {
    ...
    public FlapDockPerspective layoutPerspective(FlapDockStationLayout layout,
    ...
    public void layoutPerspective(FlapDockPerspective perspective, FlapDockStationLayout layout, Map<Integer,
            PerspectiveDockable> children) {
        perspective.read(layout.getPlaceholders(), children);
    }

    public FlapDockStationLayout getPerspectiveLayout(FlapDockPerspective element,
    ...
    public FlapDockStation layout(FlapDockStationLayout layout, Map<Integer, Dockable> children,
                                  PlaceholderStrategy placeholders) {
