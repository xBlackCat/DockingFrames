...
public class WindowMover {
     ...
     */
    private final MouseInputAdapter listener = new Listener();
    ...
    private class VetoListener extends VetoableDockRelocatorAdapter {
        private final DockRelocator relocator;
            ...
            if (!e.isConsumed() && !window.isFullscreen()) {
                ...
                if (allowDragAndDrop) {
                    ...
                    if (controller != null) {
                        ...
                        switch (reaction) {
                            case BREAK, BREAK_CONSUMED -> relocator = null;
                            case CONTINUE, CONTINUE_CONSUMED -> installDragAcceptance();
                        }
                    }
                }
            }
                ...
                if (startPoint != null) {
                    ...
                    if (bounds == null) {
                        bounds = new Rectangle(
                                startBoundaries.x + dx,
                                startBoundaries.y + dy, startBoundaries.width, startBoundaries.height);
                    }
