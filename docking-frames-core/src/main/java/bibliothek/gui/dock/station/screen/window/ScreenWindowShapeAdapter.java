...
/**
 * The {@link ScreenWindowShapeAdapter} makes a connection between a {@link ScreenDockWindow} and a
 * {@link ScreenWindowShape}
...
public class ScreenWindowShapeAdapter {
    ...
    /**
     * Sets the shape of {@link #getWindow() the window}. This method calls
     * {@link Workarounds#setTransparent(Window, Shape)},
