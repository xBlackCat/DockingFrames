...
/**
 * Supporting class for {@link SplitDockStation}, provides the implementation of
 * {@link SplitDockStation#getPlaceholders()}
 * and {@link SplitDockStation#setPlaceholders(PlaceholderMap)}
 *
 * @author Benjamin Sigg
 */
public class SplitPlaceholderConverter extends AbstractSplitPlaceholderConverter<SplitDockStation, SplitNode,
        Dockable> {
    /**
