...
public interface MagnetRequest {
     ...
     *                                  <code>neighborSide</code> are not the same and not the opposite (e.g. north
     *                                  and west)
     */
    void resizingAttraction(ScreenDockWindow neighbor, Side windowSide, Side neighborSide);
     ...
     *                                  and west)
     */
    void movingAttraction(ScreenDockWindow neighbor, Side windowSide, Side neighborSide);
