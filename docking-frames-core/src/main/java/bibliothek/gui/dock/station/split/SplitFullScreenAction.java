...
public class SplitFullScreenAction extends GroupedButtonDockAction<Boolean> implements ListeningDockAction {
    private final SplitDockStation split;
    private DockController controller;

    private final DockActionIcon iconNormalize;
    private final DockActionIcon iconMaximize;

    private final DockActionText textNormalize;
    private final DockActionText textMaximize;
    private final DockActionText textNormalizeTooltip;
    private final DockActionText textMaximizeTooltip;

    private final PropertyValue<KeyStroke> accelerator = new PropertyValue<>(SplitDockStation.MAXIMIZE_ACCELERATOR) {
        @Override
    ...
    public SplitFullScreenAction(SplitDockStation station) {
        ...
        station.addSplitDockStationListener((station1, oldFullScreen, newFullScreen) -> {
