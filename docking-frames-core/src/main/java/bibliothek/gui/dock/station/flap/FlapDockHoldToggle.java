...
public class FlapDockHoldToggle extends GroupedSelectableDockAction.Check<Boolean> implements ListeningDockAction {
    private final FlapDockStation flap;
    private DockController controller;

    private final Listener[] icons;
    private final DockActionText textStick;
    private final DockActionText textStickTooltip;
    private final DockActionText textFree;
    private final DockActionText textFreeTooltip;
    ...
    public FlapDockHoldToggle(FlapDockStation station) {
        ...
        station.addFlapDockStationListener((station1, dockable, hold) -> {
            if (isBound(dockable)) {
