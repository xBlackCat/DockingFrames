...
public class StickMagnetGraphConstraint {
     ...
     */
    private final boolean[] hard = new boolean[4];
    ...
    /**
     * Calls {@link #set(MagnetRequest.Side, int)}, {@link #setDirect(MagnetRequest.Side, boolean)} and
     * {@link #setHard(MagnetRequest.Side, boolean)}.
     *
