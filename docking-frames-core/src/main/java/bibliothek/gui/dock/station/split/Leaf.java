...
public class Leaf extends SpanSplitNode {
     ...
     *                            replaced by the map provided by the current {@link Dockable} which is a
     *                            {@link DockStation}
     */
    public void setDockable(Dockable dockable, DockHierarchyLock.Token token, boolean updatePlaceholders,
