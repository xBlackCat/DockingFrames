...
public interface BoundaryRestriction {
     ...
     */
    BoundaryRestriction FREE = new AbstractBoundaryRestriction() {
        @Override
     ...
     */
    BoundaryRestriction MEDIUM = new MediumBoundaryRestriction();

    /**
     * A restriction that will ensure that every dialog is always visible on
     * exactly one screen.
     */
    BoundaryRestriction HARD = new HardBoundaryRestriction();
