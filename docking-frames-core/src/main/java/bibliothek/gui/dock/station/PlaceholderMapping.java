...
public interface PlaceholderMapping {
     ...
     * location. If another dockable is dropped on this station, and that item is associated with
     ...
     * @throws IllegalArgumentException if <code>dockable</code> is not a child of this station, or if any argument
     * is <code>null</code>
     */
