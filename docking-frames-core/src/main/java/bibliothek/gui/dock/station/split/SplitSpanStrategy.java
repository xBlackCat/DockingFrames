...
public class SplitSpanStrategy {
    ...
    private final StationSpanFactoryValue factory;
    ...
    public void setPut(PutInfo info) {
        ...
        if (info != null) {
            ...
            if (spans != null) {
                ...
                switch (put) {
                    case LEFT -> size = (int) (node.getSize().width * divider);
                    case RIGHT -> size = (int) (node.getSize().width * (1 - divider));
                    case TOP -> size = (int) (node.getSize().height * divider);
                    case BOTTOM -> size = (int) (node.getSize().height * (1 - divider));
                }
    ...
    public int putToPosition(Put put) {
        return switch (put) {
            ...
            case TOP -> TOP;
            case BOTTOM -> BOTTOM;
            default -> throw new IllegalArgumentException("not a side: " + put);
        };
    }
