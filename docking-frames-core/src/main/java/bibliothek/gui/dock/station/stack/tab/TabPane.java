...
public interface TabPane {
     ...
     */
    PropertyKey<TabLayoutManager> LAYOUT_MANAGER =
            new PropertyKey<>("dock.tabpane.layout_manager",
                    new DynamicPropertyFactory<>() {
                        public TabLayoutManager getDefault(PropertyKey<TabLayoutManager> key,
     ...
     */
    PropertyKey<Boolean> USE_SMALL_MINIMUM_SIZE =
            new PropertyKey<>("dock.tabpane.layout_manager.small",
                    new ConstantPropertyFactory<>(true),
                    true);
