...
public class SplitDockStationLayout {
     ...
     */
    private final boolean hasFullscreenAction;
    ...
    public static abstract class Entry {
         ...
         */
        private final Path[] placeholders;
        /**
    ...
    public static class Node extends Entry {
         ...
         */
        private final Entry childA;
        /**
         * the bottom or right child
         */
        private final Entry childB;
         ...
         */
        public Node(Orientation orientation, double divider, Entry childA, Entry childB, Path[] placeholders,
