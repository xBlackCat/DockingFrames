 ...
 * <ul>
 * <li>{@link FlapDockStation#updateHold(Dockable)} when the hold property of a <code>Dockable</code> needs to be
 * changed</li>
 * <li>{@link FlapDockStation#updateWindowSize(Dockable)} when the size of a <code>Dockable</code> needs to be
 * updated</li>
 * </ul>
 *
...
public interface FlapLayoutManager {
    ...
    /**
     * Tells whether the user is supposed to switch the {@link #setHold(FlapDockStation, Dockable, boolean) hold}
     * property.
     *
     * @param station  the caller
