...
public class MenuLineLayoutOrder implements Iterable<MenuLineLayoutOrder.Item> {
    ...
    public MenuLineLayoutOrder(Item first, Item second, Item third) {
        ...
        order = new ItemConstraints[]{new ItemConstraints(first), new ItemConstraints(second),
                new ItemConstraints(third)};
    }
    ...
    /**
     * Sets the fill ratio of <code>item</code>. The fill parameter tells how much free space is used up by
     * <code>item</code>.
     * A value of 0 indicates that <code>item</code> does not use any free space, a value of 1 indicates that
     * <code>item</code>
