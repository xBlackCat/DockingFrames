...
public interface SplitTreeFactory<N> {
     ...
     */
    N horizontal(N left, N right, double divider, long id, Path[] placeholders, PlaceholderMap placeholderMap,
                 boolean visible);
     ...
     * @return the representation of this node, might be <code>null</code>
     */
    N vertical(N top, N bottom, double divider, long id, Path[] placeholders, PlaceholderMap placeholderMap,
               boolean visible);
