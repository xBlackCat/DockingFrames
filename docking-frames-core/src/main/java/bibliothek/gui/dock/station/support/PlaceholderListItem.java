 ...
 * Clients should notice that there are no restrictions on what <code>D</code> actually is. While the default
 * implementation
 * assumes that <code>D</code> is some kind of {@link Dockable}, it could as well be something else, e.g. a list of
 * dockables.
 *
