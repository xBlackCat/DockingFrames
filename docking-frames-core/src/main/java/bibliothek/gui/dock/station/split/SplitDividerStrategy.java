 ...
 * <ul><li>Adding a {@link MouseListener} and a {@link MouseMotionListener} to the {@link Component} that is given
 * during the
 * {@link #install(SplitDockStation, Component) installation}.</li>
 * <li>If the user presses the mouse the strategy will use {@link SplitDockStation#getRoot()} and
 * {@link SplitNode#getDividerNode(int, int)} to find the {@link Node} that
 ...
 * the children.</li>
 * <li>Through {@link SplitDockStation#getCurrentSplitLayoutManager()} and
 * {@link SplitLayoutManager#validateDivider(SplitDockStation, double, Node)} a strategy
