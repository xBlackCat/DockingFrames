...
public interface CombinedMenuContent {
     ...
     */
    PropertyKey<CombinedMenuContent> MENU_CONTENT = new PropertyKey<>(
            "dock.CombinedMenuContent", new DynamicPropertyFactory<>() {
     ...
     */
    void open(DockController controller, Component parent, int x, int y, Item[] content);
