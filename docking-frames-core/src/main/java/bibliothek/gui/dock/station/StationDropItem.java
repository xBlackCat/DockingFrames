...
public class StationDropItem {
    ...
    public StationDropItem(int mouseX, int mouseY, int titleX, int titleY, Dockable dockable) {
        this(mouseX, mouseY, titleX, titleY, dockable, dockable.getComponent().getSize(),
                dockable.getComponent().getMinimumSize());
    }
     ...
     */
    public StationDropItem(int mouseX, int mouseY, int titleX, int titleY, Dockable dockable, Dimension size,
                           Dimension minimum) {
        this.mouseX = mouseX;
        this.mouseY = mouseY;
        this.titleX = titleX;
