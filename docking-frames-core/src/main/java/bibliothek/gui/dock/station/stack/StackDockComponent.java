...
public interface StackDockComponent {
     ...
     * @return the tab or <code>null</code> if no tab exists or tabs cannot be used as
     * {@link DockElementRepresentative}s
     */
     ...
     *
     * @param target the target for the new representative, may or may not be a child of this component, not
     *               <code>null</code>
     * @return the new representation, can be <code>null</code> if this <code>StackDockComponent</code> does not
     * allow to
     * use its free spaces
     */
