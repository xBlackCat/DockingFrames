...
public class DefaultDockActionDistributor implements DockActionDistributor {
    ...
    /**
     * Creates a new {@link DockActionSource} for the {@link DockActionDistributor.Target}
     * {@link DockActionDistributor.Target#TAB}.
     *
    ...
    /**
     * Creates a new {@link DockActionSource} for the {@link DockActionDistributor.Target}
     * {@link DockActionDistributor.Target#INFO_COMPONENT}.
     *
     * @param source the basic actions
     * @return the filtered actions
     */
    ...
    /**
     * Creates a new {@link DockActionSource} for the {@link DockActionDistributor.Target}
     * {@link DockActionDistributor.Target#TITLE} or for
    ...
    protected DockActionSource createTitleSource(DockActionSource source) {
        return new FilteredDockActionSource(source) {
            ...
            protected boolean include(DockAction action) {
                ...
                return clazz.getAnnotation(TabDockAction.class) == null &&
                        clazz.getAnnotation(InfoDockAction.class) == null;
            }
        };
    }
}
