...
public class ScreenDockDialog extends AbstractScreenDockWindow {
     ...
     * @param undecorated   whether the dialog should suppress the default decorations
     */
    public ScreenDockDialog(ScreenDockStation station, WindowConfiguration configuration, Frame frame,
                            boolean undecorated) {
        super(station, configuration);
     ...
     * @param undecorated   whether the dialog should suppress the default decorations
     */
    public ScreenDockDialog(ScreenDockStation station, WindowConfiguration configuration, Dialog dialog,
                            boolean undecorated) {
        super(station, configuration);
