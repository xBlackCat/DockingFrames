...
public interface Combiner {
     ...
     *               means that this method may or may not success. In general the modules in the framework expect
     *               that a value below
     *               <code>0.5</code> results in <code>null</code>, while a value above <code>0.5f</code> results in
     ...
     * it more efficiently.
     *
     * @param source information about the two {@link Dockable}s that are going to be merged, not <code>null</code>.
     *               This
     *               object may or may not have been created by this {@link Combiner}, some sanity checks are advised
     *               before using it
     * @param target information that was created by {@link #prepare(CombinerSource, Enforcement)} using <code>source
