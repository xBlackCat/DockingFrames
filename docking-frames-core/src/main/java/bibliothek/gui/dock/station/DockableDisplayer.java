...
public interface DockableDisplayer extends DockComponentRoot {
     ...
     *               {@link Enforcement#getForce() force} property is high, then the result should more likely not be
     *               <code>null</code>.
     *               Note that a result of <code>null</code> is always a valid result, even if the caller does not
     *               like it.
