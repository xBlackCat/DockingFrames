...
public interface SplitLayoutManager {
     ...
     * If there is already information set, then the station will silently assume that this manager did set the
     * information
    ...
    /**
     * Call forwarded from {@link DockStation#prepareDrop(bibliothek.gui.dock.station.StationDropItem) DockStation
     * .prepareDrop} if
