...
public interface FlapLayoutManagerListener {
    /**
     * This method is called by <code>manager</code> if the
     * {@link FlapLayoutManagerListener#holdSwitchableChanged(FlapLayoutManager, FlapDockStation, Dockable)}
     ...
     * @param dockable the element for which the value changed, <code>null</code> indicates that the property changed
     *                for an unknown number of dockables
     */
