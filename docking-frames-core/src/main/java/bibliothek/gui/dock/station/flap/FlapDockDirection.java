...
public class FlapDockDirection extends SimpleMenuAction implements ListeningDockAction {
    private final DirectedArrow north;
    private final DirectedArrow south;
    private final DirectedArrow east;
    private final DirectedArrow west;
    private final DirectedArrow center;
    private DockController controller;

    private final FlapIcon[] icons;
    private final DockActionText[] texts;
    ...
    private class FlapIcon extends DockActionIcon {
        ...
        protected void changed(Icon oldValue, Icon icon) {
            String key = getId();
            switch (key) {
                case "flap.direction" -> setIcon(icon);
                case "flap.north" -> north.setIcon(icon);
                case "flap.south" -> south.setIcon(icon);
                case "flap.east" -> east.setIcon(icon);
                case "flap.west" -> west.setIcon(icon);
                case "flap.auto" -> center.setIcon(icon);
            }
        }
    }
