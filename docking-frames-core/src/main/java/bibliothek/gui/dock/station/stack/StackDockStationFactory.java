 ...
 */
public class StackDockStationFactory implements DockFactory<StackDockStation, StackDockPerspective,
    ...
    public void estimateLocations(StackDockStationLayout layout, final LocationEstimationMap children) {
        if (layout instanceof RetroStackDockStationLayout retroLayout) {
    ...
    public StackDockPerspective layoutPerspective(StackDockStationLayout layout,
    ...
    public void layoutPerspective(StackDockPerspective perspective, StackDockStationLayout layout, Map<Integer,
    ...
    public StackDockStationLayout getPerspectiveLayout(StackDockPerspective element, Map<PerspectiveDockable,
            Integer> children) {
