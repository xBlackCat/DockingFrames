...
public class HardBoundaryRestriction extends AbstractBoundaryRestriction {
     ...
     * 1 means "perfect".
     */
    protected double measureBounds(ScreenDockWindow window, int x, int y, int width, int height,
     ...
     */
    protected Rectangle boundsInDevice(ScreenDockWindow window, int x, int y, int width, int height,
                                       GraphicsDevice device) {
