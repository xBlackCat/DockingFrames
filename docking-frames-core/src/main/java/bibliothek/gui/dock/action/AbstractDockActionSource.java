...
public abstract class AbstractDockActionSource implements DockActionSource {
     ...
     */
    protected final List<DockActionSourceListener> listeners = new ArrayList<>();
    ...
    protected void fireAdded(int firstIndex, int lastIndex) {
        for (DockActionSourceListener listener : listeners.toArray(new DockActionSourceListener[0])) {
