...
public class ActionContentModifier {
    /**
     * no modifier at all. The framework never uses this modifier directly, instead one of vertical or horizontal
     * versions of this modifier is used.
     */
    ...
    public static final ActionContentModifier NONE_VERTICAL =
            new ActionContentModifier("dock.none.vertical", true, false, true, NONE);
    /**
    ...
    public static final ActionContentModifier NONE_HORIZONTAL =
            new ActionContentModifier("dock.none.horizontal", true, true, false, NONE);

    /**
     * the mouse is somehow hovering over the action. The framework never uses this modifier directly, instead one of
     * vertical or horizontal versions of this modifier is used.
     */
    ...
    public static final ActionContentModifier NONE_HOVER_VERTICAL =
            new ActionContentModifier("dock.none.hover.vertical", true, false, true, NONE_HOVER, NONE_VERTICAL);
    /**
    ...
    public static final ActionContentModifier NONE_HOVER_HORIZONTAL =
            new ActionContentModifier("dock.none.hover.horizontal", true, true, false, NONE_HOVER, NONE_HORIZONTAL);

    /**
     * the mouse was pressed over the action. The framework never uses this modifier directly, instead one of
     * vertical or horizontal versions of this modifier is used.
     */
    public static final ActionContentModifier NONE_PRESSED = new ActionContentModifier("dock.none.pressed", true,
            NONE_HOVER);
    /**
    ...
    public static final ActionContentModifier NONE_PRESSED_VERTICAL =
            new ActionContentModifier("dock.none.pressed.vertical", true, false, true, NONE_PRESSED, NONE_VERTICAL);
    /**
    ...
    public static final ActionContentModifier NONE_PRESSED_HORIZONTAL =
            new ActionContentModifier("dock.none.pressed.horizontal", true, true, false, NONE_PRESSED, NONE_HORIZONTAL);

    /**
     * the action is disabled. The framework never uses this modifier directly, instead one of vertical or horizontal
     * versions of this modifier is used.
     */
    ...
    public static final ActionContentModifier DISABLED_VERTICAL =
            new ActionContentModifier("dock.disabled.vertical", false, false, true, DISABLED, NONE_VERTICAL);
    /**
    ...
    public static final ActionContentModifier DISABLED_HORIZONTAL =
            new ActionContentModifier("dock.disabled.horizontal", false, true, false, DISABLED, NONE_HORIZONTAL);

    /**
     * the action is disabled and the mouse is hovering over the action. The framework never uses this modifier
     * directly, instead one of vertical or horizontal versions of this modifier is used.
     */
    public static final ActionContentModifier DISABLED_HOVER = new ActionContentModifier("dock.disabled.hover", false
            , DISABLED);
    /**
     * the action is disabled and the mouse is hovering over the action, the action is guaranteed to be shown vertically
     */
    public static final ActionContentModifier DISABLED_HOVER_VERTICAL = new ActionContentModifier(
            "dock.disabled.hover.vertical", false, false, true, DISABLED_HOVER, DISABLED_VERTICAL);
    /**
     * the action is disabled and the mouse is hovering over the action, the action is guaranteed to be shown
     * horizontally
     */
    public static final ActionContentModifier DISABLED_HOVER_HORIZONTAL = new ActionContentModifier(
            "dock.disabled.hover.horizontal", false, true, false, DISABLED_HOVER, DISABLED_HORIZONTAL);

    /**
     * the action is disabled and the mouse is pressed over the action. The framework never uses this modifier
     * directly, instead one of vertical or horizontal versions of this modifier is used.
     */
    public static final ActionContentModifier DISABLED_PRESSED = new ActionContentModifier("dock.disabled.pressed",
            false, DISABLED_HOVER);
    /**
     * the action is disabled and the mouse is pressed over the action, the action is guaranteed to be shown vertically
     */
    public static final ActionContentModifier DISABLED_PRESSED_VERTICAL = new ActionContentModifier("dock.disabled" +
            ".pressed.vertical", false, false, true, DISABLED_PRESSED, DISABLED_VERTICAL);
    /**
     * the action is disabled and the mouse is pressed over the action, the action is guaranteed to be shown
     * horizontally
     */
    public static final ActionContentModifier DISABLED_PRESSED_HORIZONTAL = new ActionContentModifier("dock.disabled" +
            ".pressed.horizontal", false, true, false, DISABLED_PRESSED, DISABLED_HORIZONTAL);
     ...
     *                responsibility to ensure, that no cycle of modifiers is built. This argument can be
     *                <code>null</code>.
     */
     ...
     *                   <code>null</code>.
     */
    public ActionContentModifier(String id, boolean enabled, boolean horizontal, boolean vertical,
    ...
    /**
     * Tells whether the {@link DockAction} is supposed to be
     * {@link StandardDockAction#isEnabled(bibliothek.gui.Dockable) enabled}
