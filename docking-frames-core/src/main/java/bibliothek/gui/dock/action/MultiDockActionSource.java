...
public class MultiDockActionSource extends AbstractDockActionSource {
    private final List<DockActionSource> sources = new ArrayList<>();
    private final List<SeparatorSource> separators = new ArrayList<>();
    ...
    public Iterator<DockAction> iterator() {
        return new Iterator<>() {
            private final Iterator<DockActionSource> sourceIterator = sources.iterator();
    ...
    public DockAction getDockAction(int index) {
        ...
        for (DockActionSource source : sources) {
            ...
            if (sum <= index && index < sum + length) {
                return source.getDockAction(index - sum);
            }
    ...
    private class SeparatorSource extends DefaultDockActionSource {
        private final DockActionSource predecessor;
