 ...
 * is {@link DockController#addActionOffer(ActionOffer) added} to the {@link DockController}. When the
 * {@link Dockable}s method
...
public interface ActionOffer {
     ...
     */
    DockActionSource getSource(Dockable dockable, DockActionSource source, DockActionSource[] guards,
