...
public abstract class AbstractStandardDockAction implements StandardDockAction {
     ...
     */
    protected final List<StandardDockActionListener> listeners = new ArrayList<>();

    /**
     * All {@link Dockable Dockables} which can be used by this action
     */
    private final Map<Dockable, Integer> bound = new HashMap<>();
    ...
    protected void fireActionTextChanged(Set<Dockable> dockables) {
        for (StandardDockActionListener listener : listeners.toArray(new StandardDockActionListener[0])) {
    ...
    /**
     * Invokes the
     * {@link StandardDockActionListener#actionIconChanged(StandardDockAction, ActionContentModifier, Set)
     * actionIconChanged}-
     * method of all currently registered {@link StandardDockActionListener}
     *
    ...
    /**
     * Invokes the
     * {@link StandardDockActionListener#actionRepresentativeChanged(StandardDockAction, Set)
