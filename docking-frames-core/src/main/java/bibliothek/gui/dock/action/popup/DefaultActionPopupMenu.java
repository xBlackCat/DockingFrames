...
public class DefaultActionPopupMenu implements ActionPopupMenu {
     ...
     */
    private final MenuMenuHandler handler;

    /**
     * all the listeners that were added to this menu
     */
    private final List<ActionPopupMenuListener> listeners = new ArrayList<>();
    ...
    private void fireClosed() {
        for (ActionPopupMenuListener listener : listeners.toArray(new ActionPopupMenuListener[0])) {
