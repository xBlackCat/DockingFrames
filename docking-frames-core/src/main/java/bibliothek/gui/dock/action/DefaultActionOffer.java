...
public class DefaultActionOffer implements ActionOffer {
    ...
    public DockActionSource getSource(Dockable dockable, DockActionSource source, DockActionSource[] guards,
        ...
        List<DockActionSource> sources = new ArrayList<>();
