...
public abstract class PredefinedPerspective extends Perspective {
    private final Map<String, PerspectiveElement> stringToElement = new HashMap<>();
    private final Map<PerspectiveElement, String> elementToString = new HashMap<>();

    private final List<PredefinedMap> maps = new ArrayList<>();
    ...
    public String[] getKeys() {
        return stringToElement.keySet().toArray(new String[0]);
    }
