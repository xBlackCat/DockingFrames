...
public interface DockConverter<D extends DockElement, P extends PerspectiveElement, L> {
     ...
     *                 the exact same identifiers would be given to
     *                 {@link DockConverter#getLayout(bibliothek.gui.dock.DockElement, Map)}.
     ...
     */
    L getPerspectiveLayout(P element, Map<PerspectiveDockable, Integer> children);
     ...
     *                     Factories loading only {@link Dockable}s but no {@link DockStation}s can safely ignore
     *                     this argument.
     */
    void setLayout(D element, L layout, Map<Integer, Dockable> children, PlaceholderStrategy placeholders);
     ...
     */
    void write(L layout, DataOutputStream out) throws IOException;
     ...
     * @throws IOException if an I/O-error occurs
     */
    L read(DataInputStream in, PlaceholderStrategy placeholders) throws IOException;
