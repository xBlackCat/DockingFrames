...
public class PropertyTransformer {
    ...
    private final Map<String, DockablePropertyFactory> factories = new HashMap<>();
    ...
    public PropertyTransformer(DockController controller, DockablePropertyFactory... factories) {
        ...
        List<DockablePropertyFactory> extensions =
                controller.getExtensions().load(new ExtensionName<>(FACTORY_EXTENSION, DockablePropertyFactory.class,
                        FACTORY_EXTENSION_PARAMETER, this));
