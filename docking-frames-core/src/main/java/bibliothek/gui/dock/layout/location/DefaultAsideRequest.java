...
public class DefaultAsideRequest implements AsideRequest {
     ...
     */
    private final DockableProperty location;
    ...
    protected void setCurrent(Forward current) {
        ...
        this.resultingLayout = current.layout();
    }
    ...
    protected AsideAnswer forward(Forward forward) {
        ...
        request.setParentStation(current.station());
     ...
     * @author Benjamin Sigg
     */
    protected record DockStationForward(DockStation station) implements Forward {

        public PlaceholderMap layout() {
            return null;
        }
     ...
     * @author Benjamin Sigg
     */
    protected record CombinerForward(Combiner combiner, PlaceholderMap layout) implements Forward {
