...
public class DropDownIcon implements Icon {
     ...
     */
    private final PropertyValue<Dimension> minimumSize = new PropertyValue<>(IconManager.MINIMUM_ICON_SIZE) {
        @Override
     ...
     *
     * @param color  the color used to paint this icon, can be <code>null</code>
     * @param width  the width in pixel
     * @param height the height in pixel
     * @author Benjamin Sigg
     */
    private record DefaultIcon(int width, int height, Color color) implements Icon {
        public int getIconHeight() {
            return width();
        }
    ...
    private class DisabledIcon implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (disabledIconInvalid || disabled == null || lastForeground == null ||
                    !lastForeground.equals(currentForeground)) {
