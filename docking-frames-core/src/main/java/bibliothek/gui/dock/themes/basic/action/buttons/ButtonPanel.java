...
public class ButtonPanel extends JPanel {
     ...
     */
    private final PropertyValue<DockActionImportanceOrder> actionOrder =
            new PropertyValue<>(DockActionImportanceOrder.ORDER) {
                @Override
    ...
    private void resetVisibleActions() {
        ...
        if (menuItem == null) {
            ...
            Set<ActionItem> visibleOrdered = new HashSet<>();
