...
public class MiniButtonContent extends JComponent {
     ...
     */
    private final PropertyValue<Dimension> minimumIconSize = new PropertyValue<>(IconManager.MINIMUM_ICON_SIZE) {
        @Override
     ...
     */
    private final BasicButtonModelListener listener = new BasicButtonModelAdapter() {
        @Override
