...
public abstract class BasicHandler<D extends StandardDockAction> extends AbstractBasicHandler<D, BasicButtonModel> implements BasicTrigger, BasicTitleViewItem<JComponent> {
     ...
     */
    private final PropertyValue<ButtonContentFilter> filter = new PropertyValue<>(DockAction.BUTTON_CONTENT_FILTER) {
        @Override
     ...
     */
    private final ButtonContentFilterListener filterListener = (filter, dockable, action) -> {
