...
public interface DockActionImportanceOrder {
     ...
     */
    PropertyKey<DockActionImportanceOrder> ORDER = new PropertyKey<>("dock.actionImportance",
            new ConstantPropertyFactory<>(new DefaultDockActionImportanceOrder()), true);
