...
public class BasicStationTitle extends AbstractDockTitle {
     ...
     */
    private final TitleColor activeColor = new BasicStationTitleColor("title.station.active", Color.WHITE);
    /**
     * The foreground if the title is selected
     */
    private final TitleColor activeTextColor = new BasicStationTitleColor("title.station.active.text", Color.BLACK);

    /**
     * The background if the title is not selected
     */
    private final TitleColor inactiveColor = new BasicStationTitleColor("title.station.inactive", Color.WHITE);
    /**
     * The foreground if the title is not selected
     */
    private final TitleColor inactiveTextColor =
            new BasicStationTitleColor("title.station.inactive.text", Color.DARK_GRAY);

    /**
     * The background if the title disabled
     */
    private final TitleColor disabledColor = new BasicStationTitleColor("title.station.disabled", Color.WHITE);
    ...
    public BasicStationTitle(Dockable dockable, DockTitleVersion origin) {
        ...
        setBorder(ThemeManager.BORDER_MODIFIER +
                ".title.station.basic", BorderFactory.createBevelBorder(BevelBorder.RAISED));
        setActive(false);
