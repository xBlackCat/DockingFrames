...
public abstract class BasicDropDownButtonModel extends BasicButtonModel {
     ...
     */
    private final BasicDropDownButtonTrigger trigger;
     ...
     */
    public BasicDropDownButtonModel(JComponent owner, BasicDropDownButtonTrigger trigger,
                                    BasicResourceInitializer initializer, boolean createListener) {
    ...
    protected List<Triple<KeyStroke, String, Action>> listActions() {
        ...
        Triple<KeyStroke, String, Action> popup = new Triple<>();
