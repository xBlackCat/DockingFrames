...
public class DefaultThemeMeta implements ThemeMeta {
     ...
     */
    private final ThemeFactoryText name;
    /**
     * a detailed description of the theme
     */
    private final ThemeFactoryText description;
     ...
     */
    private final List<ThemeMetaListener> listeners = new ArrayList<>();
     ...
     */
    public DefaultThemeMeta(ThemeFactory factory, DockController controller, String nameId, String descriptionId,
                            String[] authors, URI[] webpages) {
    ...
    protected void fireNameChanged() {
        for (ThemeMetaListener listener : listeners.toArray(new ThemeMetaListener[0])) {
