...
public class BasicTheme implements DockTheme {
     ...
     */
    private final NullPriorityValue<Combiner> combiner = new NullPriorityValue<>();

    /**
     * paints on stations
     */
    private final NullPriorityValue<StationPaint> paint = new NullPriorityValue<>();

    /**
     * creates panels for Dockables
     */
    private final NullPriorityValue<DisplayerFactory> displayerFactory = new NullPriorityValue<>();

    /**
     * creates titles Dockables
     */
    private final NullPriorityValue<DockTitleFactory> titleFactory = new NullPriorityValue<>();

    /**
     * selects the image which should be displayed when moving a dockable
     */
    private final NullPriorityValue<DockableMovingImageFactory> movingImage = new NullPriorityValue<>();

    /**
     * the factory used to create components for {@link StackDockStation}
     */
    private final NullPriorityValue<StackDockComponentFactory> stackDockComponentFactory = new NullPriorityValue<>();

    /**
     * the side at which tabs are normally shown
     */
    private final NullPriorityValue<TabPlacement> tabPlacement = new NullPriorityValue<>();

    /**
     * how spans are created
     */
    private final NullPriorityValue<SpanFactory> spanFactory = new NullPriorityValue<>();
     ...
     */
    private final PropertyValue<ColorScheme> colorScheme = new PropertyValue<>(BASIC_COLOR_SCHEME) {
        @Override
     ...
     */
    private final NullPriorityValue<DockableSelection> selection = new NullPriorityValue<>();
    ...
    public BasicTheme() {
        ...
        setStackDockComponentFactory(BasicStackDockComponent::new, Priority.DEFAULT);
    ...
    protected void install(DockController controller) {
        ...
        controller.getProperties().set(StackDockStation.COMPONENT_FACTORY, stackDockComponentFactory.get(),
                Priority.THEME);
