...
/**
 * The {@link ThemeManager} is responsible for collecting properties of the current {@link DockTheme} and
...
public class ThemeManager extends TypedUIProperties {
     ...
     */
    public static final Type<DisplayerFactory> DISPLAYER_FACTORY_TYPE = new Type<>("DisplayerFactory");
     ...
     */
    private final PropertyChangeListener lookAndFeelObserver = evt -> {
    ...
    public void setTheme(DockTheme theme) {
        ...
        if (this.theme != theme) {
            ...
            try {
                ...
                ExtensionName<DockThemeExtension> name = new ExtensionName<>(
                        DockThemeExtension.DOCK_THEME_EXTENSION, DockThemeExtension.class,
                        DockThemeExtension.THEME_PARAMETER, theme);
                ...
                controller.getDockTitleManager().registerTheme(DockTitleManager.THEME_FACTORY_ID,
                        theme.getTitleFactory(controller));
