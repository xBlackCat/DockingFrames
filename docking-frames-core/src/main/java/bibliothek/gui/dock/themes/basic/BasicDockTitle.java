...
public class BasicDockTitle extends AbstractDockTitle {
     ...
     */
    private final TitleColor activeLeftColor = new BasicTitleColor("title.active.left", Color.BLACK);
    /**
     * The left color of the gradient if the title is not active
     */
    private final TitleColor inactiveLeftColor = new BasicTitleColor("title.inactive.left", Color.DARK_GRAY);
    /**
     * The left color of the gradient if the title is disabled
     */
    private final TitleColor disabledLeftColor = new BasicTitleColor("title.disabled.left", Color.LIGHT_GRAY);

    /**
     * The right color of the gradient if the title is active
     */
    private final TitleColor activeRightColor = new BasicTitleColor("title.active.right", Color.DARK_GRAY);
    /**
     * The right color of the gradient if the title is not active
     */
    private final TitleColor inactiveRightColor = new BasicTitleColor("title.inactive.right", Color.LIGHT_GRAY);
    /**
     * The right color of the gradient if the title is disabled
     */
    private final TitleColor disabledRightColor = new BasicTitleColor("title.disabled.right", Color.LIGHT_GRAY);

    /**
     * The color of the text if the title is active
     */
    private final TitleColor activeTextColor = new BasicTitleColor("title.active.text", Color.WHITE);
    /**
     * The color of the text if the title is not active
     */
    private final TitleColor inactiveTextColor = new BasicTitleColor("title.inactive.text", Color.BLACK);
    ...
    protected BasicDockTitle(Dockable dockable, DockTitleVersion origin, boolean setDefaultConditionalFonts) {
        ...
        if (setDefaultConditionalFonts) {
            addConditionalFont(DockFont.ID_TITLE_ACTIVE, TitleFont.KIND_TITLE_FONT, this::isActive, null);

            addConditionalFont(DockFont.ID_TITLE_INACTIVE, TitleFont.KIND_TITLE_FONT, () -> !isActive(), null);
        }
    }
