...
public class BasicStackDockComponent extends DefaultStackDockComponent {
    private final StackDockComponentParent station;
    ...
    protected class BasicTab extends DefaultStackDockComponent.Tab implements DockableFocusListener {
        private final TabColor colorForeground;
        private final TabColor colorForegroundSelected;
        private final TabColor colorForegroundFocused;
        private final TabColor colorBackground;
        private final TabColor colorBackgroundSelected;
        private final TabColor colorBackgroundFocused;

        private final TabColor[] colors;
