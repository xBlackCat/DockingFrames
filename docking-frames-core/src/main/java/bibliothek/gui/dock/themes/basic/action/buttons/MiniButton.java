...
public class MiniButton<M extends BasicButtonModel> extends JComponent {
    ...
    public static final String BORDER_KEY_NORMAL_SELECTED =
            ThemeManager.BORDER_MODIFIER + ".action.miniButton.normal.selected";
    /**
    ...
    /**
     * Identifier for the {@link ThemeManager} of the {@link BorderModifier} which is used for the selected mouse
     * hover state.
     */
    public static final String BORDER_KEY_MOUSE_OVER_SELECTED = ThemeManager.BORDER_MODIFIER +
            ".action.miniButton.mouseOver.selected";
    /**
     * Identifier for the {@link ThemeManager} of the {@link BorderModifier} which is used for the mouse pressed state.
     */
    public static final String BORDER_KEY_MOUSE_PRESSED = ThemeManager.BORDER_MODIFIER + ".action.miniButton" +
            ".mousePressed";
    /**
     * Identifier for the {@link ThemeManager} of the {@link BorderModifier} which is used for the selected mouse
     * pressed state.
     */
    public static final String BORDER_KEY_MOUSE_PRESSED_SELECTED = ThemeManager.BORDER_MODIFIER + ".action.miniButton" +
            ".mousePressed.selected";

    /**
     * the icon and text on this button
     */
    private final MiniButtonContent content;
     ...
     */
    private final BasicButtonModelAdapter listener = new BasicButtonModelAdapter() {
        @Override
        ...
        @Override
        public void borderChanged(BasicButtonModel model, String key, BorderModifier oldBorder,
    ...
    public void doLayout() {
        Insets insets = getMaxBorderInsets();
        content.setBounds(insets.left, insets.top,
                getWidth() - insets.right - insets.left, getHeight() - insets.top - insets.bottom);
    }
    ...
    protected Insets getMaxBorderInsets() {
        ...
        for (int i = 0; i < 6; i++) {
            Border border = switch (i) {
                case 0 -> getBorder(getNormalBorder(), borderKeyNormal);
                case 1 -> getBorder(getMouseOverBorder(), borderKeyMouseOver);
                case 2 -> getBorder(getMousePressedBorder(), borderKeyMousePressed);
                case 3 -> getBorder(getNormalSelectedBorder(), borderKeyNormalSelected);
                case 4 -> getBorder(getMouseOverSelectedBorder(), borderKeyMouseOverSelected);
                case 5 -> getBorder(getMousePressedSelectedBorder(), borderKeyMousePressedSelected);
                default -> null;
            };
