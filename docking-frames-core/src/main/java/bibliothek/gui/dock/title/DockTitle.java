...
public interface DockTitle extends DockElementRepresentative, DockComponentRoot {
     ...
     */
    PropertyKey<OrientationToRotationStrategy> ORIENTATION_STRATEGY =
            new PropertyKey<>("DockTitle.orientation",
                    new ConstantPropertyFactory<>(OrientationToRotationStrategy.DEFAULT), true);
