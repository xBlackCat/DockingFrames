...
public interface MissingDockableStrategy {
     ...
     */
    MissingDockableStrategy DISCARD_ALL = new MissingDockableStrategy() {
     ...
     */
    MissingDockableStrategy STORE_ALL = new MissingDockableStrategy() {
        public boolean shouldStoreHidden(String key) {
            return true;
        }
     ...
     * <code>data</code>
     */
    <L> boolean shouldCreate(DockFactory<?, ?, L> factory, L data);
}
