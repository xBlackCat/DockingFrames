...
public abstract class AbstractDockable implements Dockable {
     ...
     */
    private final PropertyValue<String> titleText;
    /**
     ...
     */
    private final PropertyValue<String> titleToolTip;
    ...
    protected AbstractDockable(PropertyKey<String> titleText, PropertyKey<String> titleTooltip) {
        this.titleText = new PropertyValue<>(titleText) {
            @Override
        ...
        this.titleToolTip = new PropertyValue<>(titleTooltip) {
            @Override
            protected void valueChanged(String oldValue, String newValue) {
    ...
    /**
     * Gets the {@link DockComponentRootHandler} which is responsible for keeping track of all the {@link Component}s
     * of this
     * dockable.
     *
    ...
    /**
     * Access to the {@link DockableStateListenerManager} which can be used to fire {@link DockableStateEvent}s. This
     * method
    ...
    public void setTitleIcon(Icon titleIcon) {
        switch (getTitleIconHandling()) {
            case KEEP_NULL_ICON -> titleIcon().setValue(titleIcon, true);
            case REPLACE_NULL_ICON -> titleIcon().setValue(titleIcon, false);
            default -> throw new IllegalStateException("unknown behavior: " + titleIconHandling);
        }
