...
public class DefaultDockableMovingImageFactory implements DockableMovingImageFactory {
     ...
     * the backup factory
     */
    private final DockableMovingImageFactory delegate;

    /**
     * the factories that are asked first
     */
    private final List<DockableMovingImageFactory> extensions;
    ...
    public DefaultDockableMovingImageFactory(DockController controller, DockableMovingImageFactory delegate) {
        extensions =
                controller.getExtensions().load(new ExtensionName<>(FACTORY_EXTENSION,
                        DockableMovingImageFactory.class));
