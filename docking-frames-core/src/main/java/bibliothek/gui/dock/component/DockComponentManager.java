...
public interface DockComponentManager {
    ...
    /**
     * Adds a new configuration, the configuration is only applied if <code>filter</code> includes a
     * {@link DockComponentRoot}, and
    ...
    /**
     * Removes <code>configuration</code> from the list of configurations. If <code>configuration</code> was added
     * more than once,
    ...
    /**
     * Adds <code>root</code> to the list of known {@link DockComponentRoot}s, informs all listeners and applies a
     * configuration
     * to <code>root</code>.
     *
