...
/**
 * A {@link DockComponentRoot} is a representation of a set of {@link Component}s, these {@link Component}s can be
 * configured
...
public interface DockComponentRoot {
    /**
     * Sets a configuration which is to be applied to all {@link Component}s (and maybe their children) of this
     * {@link DockComponentRoot}.
     *
