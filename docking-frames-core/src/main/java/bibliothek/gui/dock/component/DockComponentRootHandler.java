...
public abstract class DockComponentRootHandler {
     ...
     */
    private final Set<Component> handledComponents = new HashSet<>();
    ...
    /**
     * Adds <code>component</code> as root {@link Component}, it will be forwarded to the
     * {@link DockComponentConfiguration}.
     *
