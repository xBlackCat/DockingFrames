...
public class DefaultDockable extends AbstractDockable {
     ...
     * the content pane
     */
    private final BackgroundPanel pane = new ConfiguredBackgroundPanel(new BorderLayout(), Transparency.SOLID);
    ...
    public DefaultDockable(Component component, String title, Icon icon, IconHandling handling) {
        ...
        if (component != null) {
            clientComponent = new WeakReference<>(component);
     ...
     * ever removes and the client component from the {@link #getContentPane() content-pane}, and then adds the
     * component
     ...
     *
     * @return the component that was given to this dockable through the constructor or <code>null</code> if that
     * component
