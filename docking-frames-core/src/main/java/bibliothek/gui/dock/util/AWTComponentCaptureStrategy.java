...
public interface AWTComponentCaptureStrategy {
     ...
     */
    AWTComponentCaptureStrategy SCREEN_CAPTURE_STRATEGY = (controller, component) -> {
        try {
     ...
     */
    AWTComponentCaptureStrategy RECURSIVE_PAINT_STRATEGY = new AWTComponentCaptureStrategy() {
     ...
     */
    AWTComponentCaptureStrategy PAINT_ALL_STRATEGY = (controller, component) -> {
     ...
     */
    PropertyKey<AWTComponentCaptureStrategy> STRATEGY =
            new PropertyKey<>("dock.AWTComponentCaptureStrategy",
                    new ConstantPropertyFactory<>(PAINT_ALL_STRATEGY), true);
