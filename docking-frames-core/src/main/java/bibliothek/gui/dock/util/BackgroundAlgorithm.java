...
public abstract class BackgroundAlgorithm implements BackgroundComponent {
     ...
     */
    private final List<BackgroundAlgorithmListener> listeners = new ArrayList<>(2);
    ...
    public void setTransparency(Transparency transparency) {
        ...
        if (this.transparency != transparency) {
            ...
            for (BackgroundAlgorithmListener listener : listeners.toArray(new BackgroundAlgorithmListener[0])) {
    ...
    private class Paintable implements PaintableComponent {
        private final PaintableComponent delegate;
