...
public class FocusedWindowProvider extends AbstractWindowProvider {
    private final List<Window> history = new LinkedList<>();
    private final Set<Window> monitored = new HashSet<>();
    private Window current;

    private final WindowFocusListener listener = new WindowFocusListener() {
