...
public interface BackgroundComponent extends UIValue<BackgroundPaint> {
     ...
     */
    Path KIND = new Path("dock", "background");
     ...
     *  <li>Decorative components, like a {@link DockTitle} or a {@link Tab}, usually paint some parts of their
     *  background even if transparent.</li>
     * </ul>
     * It should be noted, that together with a {@link BackgroundPaint}, any component can be made to look as if
     * transparent.
     *
