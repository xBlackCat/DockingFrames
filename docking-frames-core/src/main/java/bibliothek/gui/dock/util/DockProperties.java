...
public class DockProperties {
     ...
     * the map of values
     */
    private final Map<PropertyKey<?>, Entry<?>> map = new HashMap<>();
    ...
    private class Entry<A> {
         ...
         */
        private final List<DockPropertyListener<A>> listeners = new ArrayList<>();
        /**
         * the value stored in this entry
         */
        private final NullPriorityValue<A> value = new NullPriorityValue<>();
        ...
        public void setValue(A value, Priority priority) {
            ...
            if ((oldValue == null && newValue != null) ||
                ...
                for (DockPropertyListener<A> listener :
                        (DockPropertyListener<A>[]) listeners.toArray(new DockPropertyListener<?>[0])) {
