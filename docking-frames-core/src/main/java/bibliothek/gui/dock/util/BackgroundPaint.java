...
public interface BackgroundPaint {
     ...
     */
    BackgroundPaint TRANSPARENT = new BackgroundPaint() {
     ...
     */
    BackgroundPaint SOLID = new BackgroundPaint() {
        public void uninstall(BackgroundComponent component) {
            component.setTransparency(Transparency.DEFAULT);
        }
     ...
     * 	<li>If these methods are called with an argument of <code>null</code> then they will neither paint nor be
     * 	executed automatically.</li>
     * 	<li>If these methods are called with an argument not <code>null</code> then they paint but will not be
     * 	executed automatically.</li>
     * </ul>
     ...
     *  <li>Painting over children ({@link Component}s) will almost certainly not work. The framework uses special
     *  transparent panels to do that.</li>
     *  <li>Painting semi-transparent children will almost certainly not work because the children may not be marked
     *  as transparent (see {@link JComponent#isOpaque()}.</li>
     *  <li>In general painting should not require much time (a few milliseconds at most) because painting can happen
     *  often.</li>
     * </ul>
     *
