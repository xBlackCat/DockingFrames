...
public class TypedPropertyUIScheme implements UIScheme<Object, UIValue<Object>, UIBridge<Object, UIValue<Object>>> {
     ...
     */
    private final List<UISchemeListener<Object, UIValue<Object>, UIBridge<Object, UIValue<Object>>>> listeners =
            new ArrayList<>();
    ...
    public <V, A extends V> void link(PropertyKey<A> source, TypedUIProperties.Type<V> destinationType,
        ...
        if (old != null) {
            ...
            Link<V, A> link = new Link<>(source, destinationType, destinationId);
            links.put(id, link);
            if (bound > 0) {
    ...
    protected void fire(UISchemeEvent<Object, UIValue<Object>, UIBridge<Object, UIValue<Object>>> event) {
        UISchemeListener<Object, UIValue<Object>, UIBridge<Object, UIValue<Object>>>[] array =
                listeners.toArray(new UISchemeListener[0]);
    ...
    public UIBridge<Object, UIValue<Object>> getBridge(Path name, UIProperties<Object, UIValue<Object>,
            UIBridge<Object, UIValue<Object>>> properties) {
        return null;
    }
    ...
    private class Link<V, A extends V> extends PropertyValue<A> {
        private final TypedUIProperties.Type<V> type;
