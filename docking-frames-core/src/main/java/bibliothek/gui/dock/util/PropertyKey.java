...
public class PropertyKey<A> {
     ...
     * This key should only be used for writing the icon, reading the icon should be done through the
     * {@link IconManager}
    ...
    public static final PropertyKey<String> DOCK_STATION_TITLE =
            new PropertyKey<>("java.lang.String_dock_station_title");
     ...
     */
    public static final PropertyKey<String> DOCK_STATION_TOOLTIP =
            new PropertyKey<>("java.lang.String_dock_station_tooltip");
