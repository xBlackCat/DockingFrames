...
public class PriorityValue<T> {
    ...
    public boolean set(Priority priority, T value) {
        ...
        switch (priority) {
            case DEFAULT -> valueDefault = value;
            case THEME -> valueTheme = value;
            case CLIENT -> valueClient = value;
        }
    ...
    public T get(Priority priority) {
        return switch (priority) {
            case CLIENT -> valueClient;
            case DEFAULT -> valueDefault;
            case THEME -> valueTheme;
        };
    }
