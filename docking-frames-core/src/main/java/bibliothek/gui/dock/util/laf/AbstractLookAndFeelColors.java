...
public abstract class AbstractLookAndFeelColors implements LookAndFeelColors {
    protected final List<LookAndFeelColorsListener> listeners = new ArrayList<>();
    ...
    protected void fireColorChanged(String key) {
        for (LookAndFeelColorsListener listener : listeners.toArray(new LookAndFeelColorsListener[0])) {
