...
public class ExtensionManager {
     ...
     */
    private final Map<ExtensionName<?>, Share<?>> shared = new HashMap<>();
    ...
    private void tryLoadExtension(String className) throws ClassNotFoundException, InstantiationException,
    ...
    private class Share<T> {
        ...
        private final ExtensionName<T> name;
