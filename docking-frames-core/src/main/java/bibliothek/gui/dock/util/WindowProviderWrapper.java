...
public class WindowProviderWrapper implements WindowProvider {
    ...
    private final List<WindowProviderListener> listeners = new ArrayList<>();
    ...
    private final WindowProviderListener listener = new WindowProviderListener() {
    ...
    protected WindowProviderListener[] listeners() {
        return listeners.toArray(new WindowProviderListener[0]);
    }
