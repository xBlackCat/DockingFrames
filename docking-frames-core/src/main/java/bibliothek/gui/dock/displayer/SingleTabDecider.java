...
public interface SingleTabDecider {
     ...
     */
    SingleTabDecider NONE = new SingleTabDecider() {
     ...
     */
    SingleTabDecider ALWAYS = new SingleTabDecider() {
        public boolean showSingleTab(DockStation station, Dockable dockable) {
    ...
    SingleTabDecider ALLWAYS = ALWAYS;

    /**
     * Key for the {@link DockProperties}
     */
    PropertyKey<SingleTabDecider> SINGLE_TAB_DECIDER =
            new PropertyKey<>("dock.single_tab_decider",
                    new ConstantPropertyFactory<>(NONE), true);
