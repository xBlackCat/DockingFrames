...
public interface FocusStrategy {
     ...
     *                a {@link Component} is a valid target. All the information from <code>request</code> are
     *                suggestions, in the end
     *                only the result of this method will count.
     * @return the component to focus or <code>null</code>.
     * <ul>
     * 	<li><code>null</code> indicates that this strategy cannot decide what to do. In this case a default component
     * 	will receive the focus.</li>
     *  <li><code>{@link FocusStrategyRequest#getMouseClicked() mouseClicked}</code> forces focus onto
     *  <code>mouseClicked</code>, even if that <code>Component</code> is not focusable.</li>
     *  <li>any other <code>Component</code> will receive focus if focusable, or focus will be transferred to the
     *  next focusable <code>Component</code>
