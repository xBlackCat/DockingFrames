...
public interface DockRelocatorMode {
     ...
     */
    PropertyKey<ModifierMask> SCREEN_MASK =
            new PropertyKey<>("DockRelocatorMode screen mask",
                    new ConstantPropertyFactory<>(
     ...
     */
    DockRelocatorMode SCREEN_ONLY = new AcceptanceDockRelocatorMode(0, 0) {
     ...
     */
    PropertyKey<ModifierMask> NO_COMBINATION_MASK =
            new PropertyKey<>("DockRelocatorMode no combination",
                    new ConstantPropertyFactory<>(
     ...
     * This mode is installed automatically by the {@link DockController}.
     */
    DockRelocatorMode NO_COMBINATION = new AcceptanceDockRelocatorMode(0, 0) {
        public boolean accept(DockStation parent, Dockable child) {
