...
public abstract class AbstractDockRelocator implements DockRelocator {
     ...
     */
    private final List<VetoableDockRelocatorListener> vetoableListeners = new ArrayList<>();
     ...
     */
    private final List<DockRelocatorMode> modes = new ArrayList<>();
    /**
     * the set of the modes that are currently active
     */
    private final Set<DockRelocatorMode> activeModes = new HashSet<>();
    ...
    /**
     * Algorithm used to override the result of
     * {@link DockStation#prepareDrop(int, int, int, int, bibliothek.gui.Dockable)}
     */
    ...
    protected VetoableDockRelocatorListener[] vetoableListeners() {
        return vetoableListeners.toArray(new VetoableDockRelocatorListener[0]);
    }
