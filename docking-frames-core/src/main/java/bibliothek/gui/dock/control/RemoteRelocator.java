...
public interface RemoteRelocator extends BasicRemoteRelocator {
     ...
     * @param dx        the x-coordinate of the mouse on the simulated Component which sent the event, 0 is a good
     *                  default-value.
     * @param dy        the y-coordinate of the mouse on the simulated Component which sent the event, 0 is a good
     *                  default-value.
     ...
     */
    Reaction init(int x, int y, int dx, int dy, int modifiers);
     ...
     * @return how this remote reacts on the call, see {@link Reaction}
     */
    Reaction drag(int x, int y, int modifiers);
     ...
     * @return how this remote reacts on the call, see {@link Reaction}
     */
    Reaction drop(int x, int y, int modifiers);
