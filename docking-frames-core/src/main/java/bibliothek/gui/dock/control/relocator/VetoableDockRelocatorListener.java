 ...
 * <b>Note:</b> this listener is intended to monitor the users actions. This listener will never be informed about
 * events
 ...
 *  <li> optional: {@link #dragging(DockRelocatorEvent)} before the {@link Dockable} is removed from its current
 *  parent. </li>
...
public interface VetoableDockRelocatorListener {
     ...
     * already has a new parent. It is even possible that the new parent is the old parent. This event can neither be
     * canceled nor forbidden.
     *
     * @param event further description
     */
