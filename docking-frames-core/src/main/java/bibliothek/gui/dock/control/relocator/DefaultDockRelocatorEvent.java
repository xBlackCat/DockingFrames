...
public class DefaultDockRelocatorEvent implements DockRelocatorEvent {
    ...
    private final Dockable[] implicit;
     ...
     */
    public DefaultDockRelocatorEvent(DockController controller, Dockable dockable, Dockable[] implicit,
                                     DockStation target, Point mouse, boolean move) {
