...
public class DefaultFocusRequest implements FocusRequest {
     ...
     */
    private final DockElementRepresentative source;
    /**
     ...
     * @param force  <code>true</code> if this request must ensure that all properties are correct, <code>false</code>
     *                 if some
     ...
     *
     * @param source    the item to focus, may be <code>null</code>
     * @param component the {@link Component} which triggered this request for example because the user clicked with
     *                     the mouse on it.
     *                  This request can assume that the focus will automatically be transferred to
     *                  <code>component</code> by the Swing framework itself.
     *                  Can be <code>null</code>, in which case this request decides on its own which
     *                  {@link Component} to focus. This request may or may
     *                  not do sanity checks concerning <code>component</code>. An invalid argument will silently be
     *                  ignored and treated
     *                  as if it would be <code>null</code>.
     * @param force     <code>true</code> if this request must ensure that all properties are correct,
     *                     <code>false</code> if some
     *                  optimizations are allowed. Clients normally can set this argument to <code>false</code>.
     */
     ...
     *
     * @param source                the item to focus, may be <code>null</code>
     * @param component             the {@link Component} which triggered this request for example because the user
     *                                 clicked with the mouse on it.
     *                              This request can assume that the focus will automatically be transferred to
     *                              <code>component</code> by the Swing framework itself.
     *                              Can be <code>null</code>, in which case this request decides on its own which
     *                              {@link Component} to focus. This request may or may
     *                              not do sanity checks concerning <code>component</code>. An invalid argument will
     *                              silently be ignored and treated
     *                              as if it would be <code>null</code>.
     * @param force                 <code>true</code> if this request must ensure that all properties are correct,
     *                                 <code>false</code> if some
     *                              optimizations are allowed. Clients normally can set this argument to
     *                              <code>false</code>.
     * @param ensureFocusSet        if <code>true</code>, then this request should make sure that either
     *                                 <code>source</code>
     ...
     * @param ensureDockableFocused if <code>true</code>, then this method should make sure that <code>source</code>
     *                              is the focus owner. This parameter is stronger that <code>ensureFocusSet</code>
     * @param hardRequest           whether this request should be executed even if the involved {@link Component}s
     *                              are not
     *                              visible.
     */
    public DefaultFocusRequest(DockElementRepresentative source, Component component, boolean force,
                               boolean ensureFocusSet, boolean ensureDockableFocused, boolean hardRequest) {
        this.source = source;
