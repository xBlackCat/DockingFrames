...
public class ComponentHierarchyObserver {
     ...
     */
    private final Set<Component> roots = new HashSet<>();
     ...
     */
    private final List<ComponentHierarchyObserverListener> listeners =
            new ArrayList<>();
    ...
    protected ComponentHierarchyObserverListener[] listeners() {
        return listeners.toArray(new ComponentHierarchyObserverListener[0]);
    }
