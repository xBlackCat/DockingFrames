 ...
 * </ul>
 * This interface is not intended to be implemented by clients, although they can if some very special behavior is
 * required.
...
public interface Dockable extends DockElement, DockElementRepresentative, PlaceholderListItem<Dockable> {
     ...
     * forward the call directly to
     * {@link bibliothek.gui.dock.dockable.DockHierarchyObserver#addDockHierarchyListener(DockHierarchyListener)}
     *
     * @param listener the new listener
     */
     ...
     * Note: when using a {@link bibliothek.gui.dock.dockable.DockHierarchyObserver},
     * forward the call directly to
     * {@link bibliothek.gui.dock.dockable.DockHierarchyObserver#removeDockHierarchyListener(DockHierarchyListener)}
     *
     * @param listener the listener to remove
