...
public class StorageDockable extends DefaultSingleCDockable {
    private static final PreferenceOperation STORE_XML =
            new PreferenceOperation("xml", Icons.get("xml"), "Store the current layout as xml");
    private static final PreferenceOperation STORE_BINARY =
            new PreferenceOperation("binary", Icons.get("binary"), "Store the current layout in binary format");
    private static final PreferenceOperation LOAD =
            new PreferenceOperation("load", Icons.get("load"), "Load the layout of this entry");
