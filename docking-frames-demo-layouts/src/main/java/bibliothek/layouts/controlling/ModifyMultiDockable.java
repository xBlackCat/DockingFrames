...
public class ModifyMultiDockable extends DefaultSingleCDockable {
    ...
    private static final PreferenceOperation ADD_MULTI_FACTORY =
            new PreferenceOperation("add factory", Icons.get("add factory"), "CControl.add( String, " +
                    "MultipleCDockableFactory");
    private static final PreferenceOperation REMOVE_MULTI_FACTORY =
            new PreferenceOperation("remove factory", Icons.get("remove factory"), "CControl" +
                    ".removeSingleBackupFactory");

    private static final PreferenceOperation ADD_MULTI_DOCKABLE =
            new PreferenceOperation("add", Icons.get("add dockable"), "CControl.add( MultipleCDockable )");
