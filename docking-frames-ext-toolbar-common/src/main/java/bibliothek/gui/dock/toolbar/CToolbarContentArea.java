...
public class CToolbarContentArea extends CContentArea {
    private final CToolbarArea eastToolbar;
    private final CToolbarArea westToolbar;
    private final CToolbarArea southToolbar;
    private final CToolbarArea northToolbar;
