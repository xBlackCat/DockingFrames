...
public class ToolbarExtendedModeEnablement implements ExtendedModeEnablement {
    ...
    public static final ExtendedModeEnablementFactory FACTORY =
            manager -> new ToolbarExtendedModeEnablement(manager.getController());

    /**
     * the current {@link ToolbarStrategy}
     */
    private final PropertyValue<ToolbarStrategy> strategy = new PropertyValue<>(ToolbarStrategy.STRATEGY) {
        @Override
