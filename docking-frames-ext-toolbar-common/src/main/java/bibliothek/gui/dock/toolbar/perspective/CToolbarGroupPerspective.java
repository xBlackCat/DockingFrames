 ...
 * <b>Important note:</b> "columns" is an abstract idea, they do not exist as {@link DockStation}s. The
 * {@link CToolbarGroupPerspective}
...
public class CToolbarGroupPerspective {
     ...
     */
    private final Map<ToolbarColumn<PerspectiveDockable, PerspectiveDockable>, Column> columns = new HashMap<>();
    ...
    private void validateAll() {
        for (Column column : columns.values().toArray(new Column[0])) {
            column.validate();
        }
    }
