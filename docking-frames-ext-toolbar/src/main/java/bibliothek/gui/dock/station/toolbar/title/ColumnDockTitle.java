...
public abstract class ColumnDockTitle extends AbstractMultiDockTitle {
    private final List<ButtonPanel> itemPanels = new ArrayList<>();
    private final ButtonPanel directPanel;
     ...
     * when necessary.
     */
    private final ColumnDockActionSourceListener listener = new ColumnDockActionSourceListener() {
        @Override
