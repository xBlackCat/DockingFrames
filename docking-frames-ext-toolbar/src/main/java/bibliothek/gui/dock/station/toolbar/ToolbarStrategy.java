...
public interface ToolbarStrategy {
     ...
     */
    PropertyKey<ToolbarStrategy> STRATEGY =
            new PropertyKey<>("dock.toolbarStrategy", new ConstantPropertyFactory<>(new DefaultToolbarStrategy()),
                    true);
     ...
     * drop operation.
     */
    Dockable ensureToolbarLayer(DockStation parent, Dockable child);
     ...
     */
    boolean isToolbarGroupPartParent(DockStation parent, Dockable child, boolean strongRelation);
