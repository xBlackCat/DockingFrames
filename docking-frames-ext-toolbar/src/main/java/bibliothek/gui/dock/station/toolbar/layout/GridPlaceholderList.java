...
public abstract class GridPlaceholderList<D, S, P extends PlaceholderListItem<D>> extends PlaceholderList<ColumnItem<D, S, P>, ColumnItem<D, S, P>, Column<D, S, P>> {
     ...
     * list.
     *
     * @param content the content of the column, not <code>null</code>
     ...
     *
     * @param converter the converter to use, can be <code>null</code>
     */
    public void setConverter(PlaceholderListItemConverter<D, P> converter) {
        if (converter == null) {
            converter = new PlaceholderListItemConverter<>() {
                @Override
     ...
     *
     * @param dockable the item to convert
     ...
     *
     * @param station the station whose children are searched
     ...
     *
     * @param dockable some element of this grid
     ...
     *
     * @param station the station whose layout is to be updated
     * @param map     the new placeholders, never <code>null</code>
     */
    ...
    private class StationItem implements ColumnItem<D, S, P> {
        ...
        public Path getPlaceholder() {
            throw new IllegalStateException(
                    "a " + getClass().getSimpleName() + " must not be asked for its placeholder");
        }
