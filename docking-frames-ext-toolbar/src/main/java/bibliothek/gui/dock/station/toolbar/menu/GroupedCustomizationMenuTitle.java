    ...
    public void bind(CustomizationMenuCallback callback) {
        ...
        titlePanel.setLayout(new LayoutManager() {
            ...
            public Dimension preferredLayoutSize(Container parent) {
                ...
                int width = Math.max(textDimension.width + textInsets.left + textInsets.right, lineDimension.width) +
                        insets.left + insets.right;
                int height = Math.max(textDimension.height + textInsets.top + textInsets.bottom, lineDimension.height) +
            ...
            public void layoutContainer(Container parent) {
                ...
                int width = Math.min(size.width,
                        parent.getWidth() - insets.left - insets.right - textInsets.left - textInsets.right);
