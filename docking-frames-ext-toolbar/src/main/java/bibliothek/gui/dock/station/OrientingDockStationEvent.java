...
public class OrientingDockStationEvent {
     ...
     */
    private final Set<Dockable> children = new HashSet<>();
     ...
     *
     * @param station  the source of the event
     * @param children the affected children or <code>null</code>, if
     ...
     *
     * @param dockable some dockable which may or may not be affected
