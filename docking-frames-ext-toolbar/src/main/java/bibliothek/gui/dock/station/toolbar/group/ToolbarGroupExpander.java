...
/**
 * This is a helper class enabling support for {@link ExpandedState} of the children of a
...
public class ToolbarGroupExpander {
    ...
    private final StrategyHandler strategyHandler = new StrategyHandler();
    ...
    public ToolbarGroupExpander(ToolbarGroupDockStation station) {
        ...
        station.getColumnModel().addListener(new ToolbarColumnModelListener<>() {
            @Override
            public void removed(ToolbarColumnModel<Dockable, StationChildHandle> model, ToolbarColumn<Dockable,
                    StationChildHandle> column, int index) {
                column.removeListener(columnHandler);
            }

            @Override
            public void inserted(ToolbarColumnModel<Dockable, StationChildHandle> model, ToolbarColumn<Dockable,
                    StationChildHandle> column, int index) {
    ...
    private class ColumnHandler implements ToolbarColumnListener<Dockable, StationChildHandle> {
        @Override
        public void inserted(ToolbarColumn<Dockable, StationChildHandle> column, StationChildHandle item,
            ...
            if (strategy != null) {
                ...
                if (state != null) {
                    if (controller != null) {
                        ...
                        controller.getHierarchyLock().onRelease(() -> {
        ...
        @Override
        public void removed(ToolbarColumn<Dockable, StationChildHandle> column, StationChildHandle item,
