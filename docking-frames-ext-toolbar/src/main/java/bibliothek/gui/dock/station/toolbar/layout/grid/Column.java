 ...
 * @param <S> the kind of object that should be treated as
 *            {@link DockStation}
 * @param <P> the type of item which represents a {@link Dockable}
 * @author Benjamin Sigg
 */

public interface Column<D, S, P extends PlaceholderListItem<D>> extends ColumnItem<D, S, P>,
                                                                        PlaceholderListItem<ColumnItem<D, S, P>> {
    /**
