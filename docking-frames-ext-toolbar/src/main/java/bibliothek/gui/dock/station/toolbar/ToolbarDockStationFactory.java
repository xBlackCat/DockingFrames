 ...
 */
public class ToolbarDockStationFactory implements DockFactory<ToolbarDockStation, ToolbarDockPerspective,
    ...
    @Override
    public ToolbarDockStationLayout getPerspectiveLayout(ToolbarDockPerspective element, Map<PerspectiveDockable,
            Integer> children) {
        PlaceholderMap map = element.getPlaceholders(children);
        return new ToolbarDockStationLayout(map, element.getExpandedState());
    }
    ...
    @Override
    public void setLayout(ToolbarDockStation element, ToolbarDockStationLayout layout,
    ...
    @Override
    public ToolbarDockStation layout(ToolbarDockStationLayout layout, Map<Integer, Dockable> children,
                                     PlaceholderStrategy placeholders) {
    ...
    @Override
    public ToolbarDockPerspective layoutPerspective(ToolbarDockStationLayout layout, Map<Integer,
