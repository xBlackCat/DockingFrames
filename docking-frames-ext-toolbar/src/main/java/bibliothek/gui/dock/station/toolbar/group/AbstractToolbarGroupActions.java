...
public abstract class AbstractToolbarGroupActions<P, C extends AbstractToolbarGroupActions<P, C>.Column> implements ColumnDockActionSource {
     ...
     */
    private final List<C> columns = new ArrayList<>();

    /**
     * all the listeners that were added to this {@link ColumnDockActionSource}
     */
    private final List<ColumnDockActionSourceListener> listeners = new ArrayList<>();
     ...
     */
    private final ToolbarColumnModelListener<Dockable, P> modelListener = new ToolbarColumnModelListener<>() {
        @Override
    ...
    protected ColumnDockActionSourceListener[] listeners() {
        return listeners.toArray(new ColumnDockActionSourceListener[0]);
    }
    ...
    protected abstract class Column {
        ...
        private final ToolbarColumnListener<Dockable, P> listener = new ToolbarColumnListener<>() {
            @Override
