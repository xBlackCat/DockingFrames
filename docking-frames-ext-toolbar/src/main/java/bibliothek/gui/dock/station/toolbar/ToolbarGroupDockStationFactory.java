 ...
 */
public class ToolbarGroupDockStationFactory implements DockFactory<ToolbarGroupDockStation,
        ToolbarGroupDockPerspective, ToolbarGroupDockStationLayout> {
    /**
    ...
    @Override
    public ToolbarGroupDockStationLayout getPerspectiveLayout(ToolbarGroupDockPerspective element,
    ...
    @Override
    public void setLayout(ToolbarGroupDockStation element, ToolbarGroupDockStationLayout layout, Map<Integer,
            Dockable> children, PlaceholderStrategy placeholders) {
        element.setExpandedState(layout.getState(), false);
        element.setPlaceholders(layout.getPlaceholders(), children);
    }

    @Override
    public void setLayout(ToolbarGroupDockStation element, ToolbarGroupDockStationLayout layout,
    ...
    public void estimateLocations(ToolbarGroupDockStationLayout layout, final LocationEstimationMap children) {
        DockablePlaceholderList.simulatedRead(layout.getPlaceholders(), new PlaceholderListItemAdapter<Dockable,
                Dockable>() {
            @Override
            public Dockable convert(ConvertedPlaceholderListItem item) {
                final int column = item.getInt("index");

                DockablePlaceholderList.simulatedRead(item.getPlaceholderMap(),
    ...
    @Override
    public ToolbarGroupDockStation layout(ToolbarGroupDockStationLayout layout, Map<Integer, Dockable> children,
                                          PlaceholderStrategy placeholders) {
