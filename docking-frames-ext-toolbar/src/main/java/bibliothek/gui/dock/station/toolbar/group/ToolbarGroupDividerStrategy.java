...
public interface ToolbarGroupDividerStrategy {
     ...
     */
    ToolbarGroupDividerStrategy NULL = new ToolbarGroupDividerStrategy() {
        @Override
     ...
     */
    void paint(Component parent, Graphics g, ToolbarGridLayoutManager<StationChildHandle> layoutManager);
}
