...
public interface ToolbarContainerConverter {
     ...
     * @return the placeholders
     */
    PlaceholderMap getPlaceholders(ToolbarContainerDockStation station, Map<Dockable, Integer> children);

    /**
     * Called by
     * {@link ToolbarDockStationFactory#getPerspectiveLayout(bibliothek.gui.dock.perspective.PerspectiveElement, Map)}
     *
     * @param station  the calling station
     * @param children identifiers for the children of the station
     * @return the placeholders
     */
    PlaceholderMap getPlaceholders(ToolbarContainerDockPerspective station, Map<PerspectiveDockable, Integer> children);
     ...
     */
    void setPlaceholders(ToolbarContainerDockStation station, PlaceholderMap map);
     ...
     * @param map      the placeholders to read
     */
    void setPlaceholders(ToolbarContainerDockStation station, ToolbarContainerConverterCallback callback,
