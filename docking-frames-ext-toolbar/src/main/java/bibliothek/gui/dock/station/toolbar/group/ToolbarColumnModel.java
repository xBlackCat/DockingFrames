 ...
 * The model does not offer any information that could not be retrieved through the methods of
 * {@link DockablePlaceholderToolbarGrid},
...
public interface ToolbarColumnModel<D, P> {
     ...
     */
    ToolbarColumn<D, P> getColumn(D dockable);
