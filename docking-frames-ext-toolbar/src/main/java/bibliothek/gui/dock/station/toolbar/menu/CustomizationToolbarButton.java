...
public abstract class CustomizationToolbarButton implements
     ...
     */
    private final DockIcon elsewhereIcon = new DockIcon(
     ...
     * @throws IllegalStateException if {@link #bind(CustomizationMenuCallback)} was not called
     */
     ...
     *
     * @param icon the new text, can be <code>null</code>
     */
