...
public interface ToolbarContainerConverterCallback {
     ...
     */
    void adding(StationChildHandle dockable);
     ...
     * @param dockable the new element, not <code>null</code>
     */
    void added(StationChildHandle dockable);
     ...
     */
    void setDockables(DockablePlaceholderList<StationChildHandle> list);
     ...
     */
    void finished(DockablePlaceholderList<StationChildHandle> list);
}