...
public class ToolbarDockableDisplayer extends BasicDockableDisplayer {
     ...
     */
    public static final DisplayerFactory FACTORY = request -> {
        ToolbarDockableDisplayer displayer =
                new ToolbarDockableDisplayer(request.getParent(), request.getTarget(), request.getTitle());
