...
public interface ExpandableToolbarItemStrategy {
     ...
     */
    PropertyKey<ExpandableToolbarItemStrategy> STRATEGY = new PropertyKey<>(
            "expandable toolbar item strategy", new DynamicPropertyFactory<>() {
        @Override
        public ExpandableToolbarItemStrategy getDefault(PropertyKey<ExpandableToolbarItemStrategy> key,
     ...
     */
    boolean isEnabled(Dockable item, ExpandedState state);
     ...
     */
    ExpandedState getState(Dockable item);
     ...
     */
    void setState(Dockable item, ExpandedState state);
