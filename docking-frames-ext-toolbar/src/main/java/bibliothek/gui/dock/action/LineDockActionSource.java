...
public class LineDockActionSource extends AbstractDockActionSource {
    private final DockActionSource source;

    private final SeparatorAction separator = new Separator();

    @DockActionImportance(value = 0.0)
    private static class Separator extends SeparatorAction {
        public Separator() {
            super(ViewTarget.TITLE);
        }
    }

    private final DockActionSourceListener listener = new DockActionSourceListener() {
        @Override
    ...
    public Iterator<DockAction> iterator() {
        return new Iterator<>() {
            ...
            private final Iterator<DockAction> inner = source.iterator();
