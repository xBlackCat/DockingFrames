...
public class ToolbarGroupDockStationSample implements DropSample {
    ...
    private final Dockable dockable = new ToolbarDockStation();
    ...
    public ToolbarGroupDockStationSample() {
        ...
        controller.getProperties().set(ToolbarGroupDockStation.HEADER_FACTORY, station -> new ToolbarGroupHeader() {
