...
import bibliothek.gui.dock.station.toolbar.menu.*;
...
public class TestBackground {
    public static void main(String[] args) {
        ...
        controller.getThemeManager().setBackgroundPaint(
                ThemeManager.BACKGROUND_PAINT + ".station.toolbar.container", new BackgroundPaint() {
                    @Override
        ...
        controller.getThemeManager().setBackgroundPaint(
                ThemeManager.BACKGROUND_PAINT + ".displayer", new BackgroundPaint() {
                    @Override
                    public void uninstall(BackgroundComponent component) {
        ...
        controller.getThemeManager().setBackgroundPaint(
                ThemeManager.BACKGROUND_PAINT + ".station.toolbar", new BackgroundPaint() {
                    @Override
                    public void uninstall(BackgroundComponent component) {
                        // ignore
                    }
        ...
        controller.getThemeManager().setBackgroundPaint(
                ThemeManager.BACKGROUND_PAINT + ".station.toolbar.group", new BackgroundPaint() {
                    @Override
                    public void uninstall(BackgroundComponent component) {
                        // ignore
                    }
