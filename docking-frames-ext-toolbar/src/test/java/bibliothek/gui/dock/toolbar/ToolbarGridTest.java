...
public class ToolbarGridTest {
    ...
    private TestGrid copyByReadWrite(TestGrid grid, Collection<Dockable> dockables) {
        Map<Integer, Dockable> idToItem = new HashMap<>();
        Map<Dockable, Integer> itemToId = new HashMap<>();
        ...
        newGrid.fromMap(map, idToItem, new PlaceholderToolbarGridConverter<>() {
            @Override
    ...
    private void assertEqualsColumn(GridPlaceholderList<Dockable, DockStation, TestItem>.Item itemA,
                                    GridPlaceholderList<Dockable, DockStation, TestItem>.Item itemB) {
    ...
    private void assertEqualsList(PlaceholderList<Dockable, DockStation, TestItem> listA, PlaceholderList<Dockable,
            DockStation, TestItem> listB) {
        assertEquals(listA.list().size(), listB.list().size());
        assertEquals(listA.dockables().size(), listB.dockables().size());
    ...
    private class TestStory implements ToolbarColumnModelListener<Dockable, TestItem>, ToolbarColumnListener<Dockable
            , TestItem> {
        private final TestGrid grid = new TestGrid();
        private final List<Dockable> dockables = new ArrayList<>();

        private final List<ToolbarColumn<Dockable, TestItem>> columns = new ArrayList<>();
        private final List<List<TestItem>> items = new ArrayList<>();
        ...
        @Override
        public void inserted(ToolbarColumnModel<Dockable, TestItem> model, ToolbarColumn<Dockable, TestItem> column,
                             int index) {
            column.addListener(this);
            columns.add(index, column);
            items.add(index, new ArrayList<>());
        }

        @Override
        public void removed(ToolbarColumnModel<Dockable, TestItem> model, ToolbarColumn<Dockable, TestItem> column,
                            int index) {
