...
public class TestWizardSplitDockStationSide {
    public static void main(String[] args) {
        ...
        for (Side side : Side.values()) {
            ...
            item.addActionListener(e -> setSide(station, frame, itemSide));
            menu.add(item);
        }
    ...
    private static void setSide(WizardSplitDockStation station, JFrame frame, Side side) {
        switch (side) {
            case BOTTOM -> frame.add(new JScrollPane(station.getComponent()), BorderLayout.SOUTH);
            case TOP -> frame.add(new JScrollPane(station.getComponent()), BorderLayout.NORTH);
            case LEFT -> frame.add(new JScrollPane(station.getComponent()), BorderLayout.WEST);
            case RIGHT -> frame.add(new JScrollPane(station.getComponent()), BorderLayout.EAST);
        }
