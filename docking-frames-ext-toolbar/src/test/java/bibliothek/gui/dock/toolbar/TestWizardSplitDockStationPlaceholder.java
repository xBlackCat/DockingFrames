...
public class TestWizardSplitDockStationPlaceholder {
    public static void main(String[] args) {
        ...
        frontend.getController().getProperties().set(PlaceholderStrategy.PLACEHOLDER_STRATEGY,
        ...
        DockableSplitDockTree.Key<Dockable> a1 = tree.put(create("A1"));
        DockableSplitDockTree.Key<Dockable> a2 = tree.put(create("A2"));
        DockableSplitDockTree.Key<Dockable> a3 = tree.put(create("A3"));
        DockableSplitDockTree.Key<Dockable> b1 = tree.put(create("B1"));
        DockableSplitDockTree.Key<Dockable> b2 = tree.put(create("B2"));
        DockableSplitDockTree.Key<Dockable> a2b = tree.put(new Path[]{new Path("test", "A2b")}, null);

        DockableSplitDockTree.Key<Dockable> col1 = tree.vertical(tree.vertical(a1, tree.horizontal(a2b, a2)), a3);
        DockableSplitDockTree.Key<Dockable> col2 = tree.vertical(b1, b2);
