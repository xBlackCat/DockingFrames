...
public class DropSamplePanel extends OverpaintablePanel {
    ...
    public DropSamplePanel() {
        ...
        getContentPane().setBorder(BorderFactory.createCompoundBorder(new EmptyBorder(50, 50, 50, 50),
    ...
    private Color layerColor(int layer) {
        return switch (layer) {
            ...
            default ->
                    throw new IllegalArgumentException("did not except a station with that many layers, need to " +
                            "define more colors");
        };
    }
