...
public class GroupingDockablesExample {
    public static void main(String[] args) {
        ...
        MultipleCDockableFactory<DefaultMultipleCDockable, ?> factory =
                new EmptyMultipleCDockableFactory<DefaultMultipleCDockable>() {
                    @Override
        ...
        frame.add(control.getContentArea(), new GridBagConstraints(0, 0, 1, 1, 100.0, 100.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
        frame.add(buildActions(control, factory), new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
    ...
    private static JComponent buildActions(CControl control,
                                           MultipleCDockableFactory<DefaultMultipleCDockable, ?> factory) {
        ...
        panel.add(buildAction("Yellow", new AddDockableAction(control, factory, Color.YELLOW, new Path("custom",
                "yellow"))));
        panel.add(buildAction("Magenta", new AddDockableAction(control, factory, Color.MAGENTA, new Path("custom",
                "magenta"))));
    ...
    private static class AddDockableAction implements ActionListener {
        ...
        public AddDockableAction(CControl control, MultipleCDockableFactory<DefaultMultipleCDockable, ?> factory,
                                 Color color, Path placeholder) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            /* We define the group of "dockable". It will now show up at the location where "placeholder" was
