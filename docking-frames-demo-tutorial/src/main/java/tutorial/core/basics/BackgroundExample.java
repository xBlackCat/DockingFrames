...
public class BackgroundExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedImage image =
                ImageIO.read(BackgroundPanel.class.getResource("/data/tutorial/shadowsAndLight_GregMartin.jpg"));
        ...
        controller.getProperties().set(DockTheme.BACKGROUND_PAINT, new CustomPaint(frame.getContentPane(), image,
                alphaDecoration));
         ...
         * example. */
        controller.getThemeManager().setBackgroundPaint(
                ThemeManager.BACKGROUND_PAINT + ".custom", new CustomPaint(frame.getContentPane(), image, alphaWork));
...
//		controller.setTheme( new BasicTheme() );
    ...
    private static BufferedImage createBackground(BufferedImage image, int width, int height) {
        ...
        g.drawImage(image,
                ...
                height / 2 + mh / 2,
                imageWidth / 2 - mw / 2,
                imageHeight / 2 - mh / 2, imageWidth / 2 + mw / 2, imageHeight / 2 + mh / 2, null);
        g.dispose();
    ...
    private static class BackgroundDockable extends DefaultDockable {
        ...
        public BackgroundDockable(String title, Color color) {
            ...
            background = new BackgroundAlgorithm(BackgroundComponent.KIND.append("custom"),
                    ThemeManager.BACKGROUND_PAINT + ".custom") {
