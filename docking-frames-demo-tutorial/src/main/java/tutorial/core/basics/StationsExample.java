...
public class StationsExample {
    public static void main(String[] args) {
        ...
        splitDockStation.drop(new ColorDockable("Split SOUTH_WEST", Color.GREEN), new SplitDockProperty(0, 0.5, 1,
                0.5));
        ...
        /* Let's add a child, in this case we need also to tell the station where exactly to show the child on the
        screen */
