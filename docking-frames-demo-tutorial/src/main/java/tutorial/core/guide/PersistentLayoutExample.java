...
public class PersistentLayoutExample {
    ...
    public static void main(String[] args) {
        ...
        grid.addDockable(50, 0, 50, 50, new CustomColorDockable("Red", Color.RED), new CustomColorDockable("Green",
                Color.GREEN));
     ...
     *  */
    private static class CustomColorDockableFactory implements DockFactory<CustomColorDockable, PerspectiveElement,
            CustomColorLayout> {
        public String getID() {
            return CUSTOM_COLOR_DOCKABLE_FACTORY_ID;
        }
        ...
        public CustomColorLayout getPerspectiveLayout(PerspectiveElement element,
                                                      Map<PerspectiveDockable, Integer> children) {
            return null;
        }

        /* ignored in this example */
        public void layoutPerspective(PerspectiveElement perspective, CustomColorLayout layout, Map<Integer,
                PerspectiveDockable> children) {
            // ignore
        }

        /* ignored in this example */
        public PerspectiveElement layoutPerspective(CustomColorLayout layout,
