...
public class PerspectiveExample {
    ...
    public static void main(String[] args) {
        ...
        StackDockPerspective stack =
                new StackDockPerspective(new PerspectiveDockable[]{dockableGreen, dockableBlue}, dockableGreen);
        ...
        SplitDockPerspective.Node node =
                new SplitDockPerspective.Node(Orientation.HORIZONTAL, 0.4, childRed, childStack, null, null, -1);
