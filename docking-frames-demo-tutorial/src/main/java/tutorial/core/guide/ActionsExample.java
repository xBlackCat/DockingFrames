...
public class ActionsExample {
    public static void main(String[] args) {
        ...
        DefaultDockActionSource actions =
                new DefaultDockActionSource(new LocationHint(LocationHint.DOCKABLE, LocationHint.LEFT));
    ...
    private static void setupRadioAction(final int index, final SimpleSelectableAction radio,
                                         SelectableDockActionGroup group, final TextDockable target) {
