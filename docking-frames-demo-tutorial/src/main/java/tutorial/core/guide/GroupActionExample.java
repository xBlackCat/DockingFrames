...
public class GroupActionExample {
    ...
    public static void main(String[] args) {
        ...
        dockableA.setActionOffers(new DefaultDockActionSource(new LocationHint(LocationHint.DOCKABLE,
                LocationHint.LEFT), action));
        dockableB.setActionOffers(new DefaultDockActionSource(new LocationHint(LocationHint.DOCKABLE,
                LocationHint.LEFT), action));
