...
public class DisplayerExample {
    public static void main(String[] args) {
        ...
        UIBridge<DisplayerFactory, UIValue<DisplayerFactory>> bridge =
                new UIBridge<DisplayerFactory, UIValue<DisplayerFactory>>() {
                    ...
                    /* this method is called when a property has to be transferred. Normally a bridge calls "uiValue
                    .set( value )", but
        ...
        controller.getThemeManager().publish(Priority.CLIENT, DisplayerFactoryValue.KIND_DISPLAYER_FACTORY,
                ThemeManager.DISPLAYER_FACTORY_TYPE, bridge);
