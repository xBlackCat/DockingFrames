...
public abstract class AbstractEntryable implements Entryable {
    ...
    public Entryable[] children() {
        return entries.toArray(Entryable[]::new);
    }
    ...
    /**
     * This either just prints the {@link TypeMirror#typeName()} of <code>type</code>
     ...
     * the {@link TypeMirror#qualifiedTypeName()}.
     *
     * @param type the type whose name should be printed
     * @see #print(String)
     * @see #link(String, String, String)
     */
    public void print(TypeMirror type) {
        if (type.getKind().isPrimitive()) {
            print(type.getKind().typeName());
        } else {
